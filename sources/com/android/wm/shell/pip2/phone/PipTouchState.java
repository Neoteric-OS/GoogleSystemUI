...
public final class PipTouchState {
    ...
    public final PipTouchHandler$$ExternalSyntheticLambda2 mDoubleTapTimeoutCallback;
    public final PipTouchHandler$$ExternalSyntheticLambda4 mHoverExitTimeoutCallback;
    ...
    public PipTouchState(ViewConfiguration viewConfiguration, PipTouchHandler$$ExternalSyntheticLambda2 pipTouchHandler$$ExternalSyntheticLambda2, PipTouchHandler$$ExternalSyntheticLambda4 pipTouchHandler$$ExternalSyntheticLambda4, ShellExecutor shellExecutor) {
        this.mViewConfig = viewConfiguration;
        this.mDoubleTapTimeoutCallback = pipTouchHandler$$ExternalSyntheticLambda2;
        this.mHoverExitTimeoutCallback = pipTouchHandler$$ExternalSyntheticLambda4;
    ...
    public final void onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            if (this.mAllowTouches) {
                ...
                PipTouchHandler$$ExternalSyntheticLambda2 pipTouchHandler$$ExternalSyntheticLambda2 = this.mDoubleTapTimeoutCallback;
                if (pipTouchHandler$$ExternalSyntheticLambda2 != null) {
                    ((HandlerExecutor) shellExecutor).removeCallbacks(pipTouchHandler$$ExternalSyntheticLambda2);
                    return;
                }
                return;
            }
        ...
        if (actionMasked != 1) {
                ...
                if (this.mIsUserInteracting) {
                    ...
                    if (findPointerIndex == -1) {
                        if (ProtoLogImpl_411527699.Cache.WM_SHELL_PICTURE_IN_PICTURE_enabled[4]) {
                            ProtoLogImpl_411527699.e(ShellProtoLogGroup.WM_SHELL_PICTURE_IN_PICTURE, -5050839515702609964L, 4, "PipTouchState", Long.valueOf(this.mActivePointerId));
                            return;
                        }
                        return;
                    }
            ...
            if (findPointerIndex2 == -1) {
                if (ProtoLogImpl_411527699.Cache.WM_SHELL_PICTURE_IN_PICTURE_enabled[4]) {
                    ProtoLogImpl_411527699.e(ShellProtoLogGroup.WM_SHELL_PICTURE_IN_PICTURE, 3776750517946036956L, 4, "PipTouchState", Long.valueOf(this.mActivePointerId));
                    return;
                }
                return;
            }
