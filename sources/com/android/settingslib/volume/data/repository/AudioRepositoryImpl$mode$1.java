...
final class AudioRepositoryImpl$mode$1 extends SuspendLambda implements Function2 {
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [android.media.AudioManager$OnModeChangedListener, com.android.settingslib.volume.data.repository.AudioRepositoryImpl$mode$1$listener$1] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final ?? r1 = new AudioManager.OnModeChangedListener() { // from class: com.android.settingslib.volume.data.repository.AudioRepositoryImpl$mode$1$listener$1
            ...
            this.this$0.audioManager.addOnModeChangedListener(ConcurrentUtils.DIRECT_EXECUTOR, r1);
            final AudioRepositoryImpl audioRepositoryImpl = this.this$0;
            Function0 function0 = new Function0() { // from class: com.android.settingslib.volume.data.repository.AudioRepositoryImpl$mode$1.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
                ...
                public final Object invoke() {
                    AudioRepositoryImpl.this.audioManager.removeOnModeChangedListener(r1);
