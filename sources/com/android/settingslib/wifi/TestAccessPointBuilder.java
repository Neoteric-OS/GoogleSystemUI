...
public class TestAccessPointBuilder {
    ...
    private ArrayList mScoredNetworkCache;
    ...
    public AccessPoint build() {
        ...
        ArrayList arrayList = this.mScanResults;
        if (arrayList != null) {
            bundle.putParcelableArray("key_scanresults", (Parcelable[]) arrayList.toArray(new Parcelable[arrayList.size()]));
        }
        ArrayList<? extends Parcelable> arrayList2 = this.mScoredNetworkCache;
        if (arrayList2 != null) {
    ...
    public TestAccessPointBuilder setScanResults(ArrayList arrayList) {
        this.mScanResults = arrayList;
        return this;
    }

    public TestAccessPointBuilder setScoredNetworkCache(ArrayList arrayList) {
