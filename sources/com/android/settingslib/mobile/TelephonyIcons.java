...
public abstract class TelephonyIcons {
    ...
    static {
        ...
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup2 = new SignalIcon$MobileIconGroup("3G", R.string.data_connection_3g, R.drawable.ic_3g_mobiledata);
        ...
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup5 = new SignalIcon$MobileIconGroup("E", R.string.data_connection_edge, R.drawable.ic_e_mobiledata);
        E = signalIcon$MobileIconGroup5;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup6 = new SignalIcon$MobileIconGroup("1X", R.string.data_connection_cdma, R.drawable.ic_1x_mobiledata);
        ONE_X = signalIcon$MobileIconGroup6;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup7 = new SignalIcon$MobileIconGroup("G", R.string.data_connection_gprs, R.drawable.ic_g_mobiledata);
        G = signalIcon$MobileIconGroup7;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup8 = new SignalIcon$MobileIconGroup("H", R.string.data_connection_3_5g, R.drawable.ic_h_mobiledata);
        H = signalIcon$MobileIconGroup8;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup9 = new SignalIcon$MobileIconGroup("H+", R.string.data_connection_3_5g_plus, R.drawable.ic_h_plus_mobiledata);
        H_PLUS = signalIcon$MobileIconGroup9;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup10 = new SignalIcon$MobileIconGroup("4G", R.string.data_connection_4g, R.drawable.ic_4g_mobiledata);
        FOUR_G = signalIcon$MobileIconGroup10;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup11 = new SignalIcon$MobileIconGroup("4G+", R.string.data_connection_4g_plus, R.drawable.ic_4g_plus_mobiledata);
        FOUR_G_PLUS = signalIcon$MobileIconGroup11;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup12 = new SignalIcon$MobileIconGroup("LTE", R.string.data_connection_lte, R.drawable.ic_lte_mobiledata);
        LTE = signalIcon$MobileIconGroup12;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup13 = new SignalIcon$MobileIconGroup("LTE+", R.string.data_connection_lte_plus, R.drawable.ic_lte_plus_mobiledata);
        ...
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup16 = new SignalIcon$MobileIconGroup("5Ge", R.string.data_connection_5ge_html, R.drawable.ic_5g_e_mobiledata);
        LTE_CA_5G_E = signalIcon$MobileIconGroup16;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup17 = new SignalIcon$MobileIconGroup("5G", R.string.data_connection_5g, R.drawable.ic_5g_mobiledata);
        NR_5G = signalIcon$MobileIconGroup17;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup18 = new SignalIcon$MobileIconGroup("5G_PLUS", R.string.data_connection_5g_plus, R.drawable.ic_5g_plus_mobiledata);
        ...
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup20 = new SignalIcon$MobileIconGroup("NotDefaultData", R.string.not_default_data_content_description, 0);
