...
final class ConfigurationRepositoryImpl$onConfigurationChange$1 extends SuspendLambda implements Function2 {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        ConfigurationRepositoryImpl$onConfigurationChange$1 configurationRepositoryImpl$onConfigurationChange$1 = new ConfigurationRepositoryImpl$onConfigurationChange$1(this.this$0, continuation);
        configurationRepositoryImpl$onConfigurationChange$1.L$0 = obj;
        return configurationRepositoryImpl$onConfigurationChange$1;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final ?? r1 = new ConfigurationController.ConfigurationListener() { // from class: com.android.systemui.common.ui.data.repository.ConfigurationRepositoryImpl$onConfigurationChange$1$callback$1
                ...
                public final void onConfigChanged(Configuration configuration) {
                    ...
                    if (mo1790trySendJP2dKIU instanceof ChannelResult.Failed) {
                        FacePropertyRepositoryImpl$cameraInfo$1$callback$1$$ExternalSyntheticOutline0.m("Failed to send ", "updated state", " - downstream canceled or failed.", "ConfigurationRepository#onConfigChanged", ChannelResult.m1791exceptionOrNullimpl(mo1790trySendJP2dKIU));
                    }
                }
            };
