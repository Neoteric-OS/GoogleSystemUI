...
public abstract class PolicyModule_Companion_ProvideMicrophoneToggleTileViewModelFactory implements Provider {
    public static QSTileViewModelImpl provideMicrophoneToggleTileViewModel(QSTileViewModelFactory$Static qSTileViewModelFactory$Static, DaggerSysUIGoogleGlobalRootComponent$SysUIGoogleSysUIComponentImpl$SwitchingProvider$47 daggerSysUIGoogleGlobalRootComponent$SysUIGoogleSysUIComponentImpl$SwitchingProvider$47, DaggerSysUIGoogleGlobalRootComponent$SysUIGoogleSysUIComponentImpl$SwitchingProvider$48 daggerSysUIGoogleGlobalRootComponent$SysUIGoogleSysUIComponentImpl$SwitchingProvider$48, DaggerSysUIGoogleGlobalRootComponent$SysUIGoogleSysUIComponentImpl$SwitchingProvider$49 daggerSysUIGoogleGlobalRootComponent$SysUIGoogleSysUIComponentImpl$SwitchingProvider$49) {
        TileSpec create = TileSpec.Companion.create("mictoggle");
        SensorPrivacyToggleTileUserActionInteractor create2 = daggerSysUIGoogleGlobalRootComponent$SysUIGoogleSysUIComponentImpl$SwitchingProvider$49.create(1);
        SensorPrivacyToggleTileDataInteractor create3 = daggerSysUIGoogleGlobalRootComponent$SysUIGoogleSysUIComponentImpl$SwitchingProvider$48.create(1);
        SensorPrivacyTileResources.MicrophonePrivacyTileResources microphonePrivacyTileResources = SensorPrivacyTileResources.MicrophonePrivacyTileResources.INSTANCE;
