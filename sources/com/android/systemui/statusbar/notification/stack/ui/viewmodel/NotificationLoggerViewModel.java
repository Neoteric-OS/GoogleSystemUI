...
import com.android.systemui.statusbar.notification.domain.interactor.ActiveNotificationsInteractor$special$$inlined$map$1;
import kotlin.Unit;
...
public final class NotificationLoggerViewModel {
    ...
    public final MutableStateFlow isOnLockScreen;
    ...
    public NotificationLoggerViewModel(ActiveNotificationsInteractor activeNotificationsInteractor, KeyguardInteractor keyguardInteractor, WindowRootViewVisibilityInteractor windowRootViewVisibilityInteractor) {
        final ActiveNotificationsInteractor$special$$inlined$map$1 activeNotificationsInteractor$special$$inlined$map$1 = activeNotificationsInteractor.allRepresentativeNotifications;
        new Flow() { // from class: com.android.systemui.statusbar.notification.stack.ui.viewmodel.NotificationLoggerViewModel$special$$inlined$map$1
            ...
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object collect = ActiveNotificationsInteractor$special$$inlined$map$1.this.collect(new AnonymousClass2(flowCollector), continuation);
                return collect == CoroutineSingletons.COROUTINE_SUSPENDED ? collect : Unit.INSTANCE;
            }
        };
        ActiveNotificationsInteractor$special$$inlined$map$1 activeNotificationsInteractor$special$$inlined$map$12 = activeNotificationsInteractor.activeNotificationRanks;
        ReadonlyStateFlow readonlyStateFlow = windowRootViewVisibilityInteractor.isLockscreenOrShadeVisibleAndInteractive;
        MutableStateFlow mutableStateFlow = keyguardInteractor.isKeyguardShowing;
    }
}
