...
public final class SharedNotificationContainerViewModel$special$$inlined$map$6 implements Flow {
    ...
    public /* synthetic */ SharedNotificationContainerViewModel$special$$inlined$map$6(MutableSharedFlow mutableSharedFlow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new SharedNotificationContainerViewModel$keyguardAlpha$$inlined$map$1$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = this.$this_unsafeTransform$inlined.collect(new SharedNotificationContainerViewModel$keyguardAlpha$$inlined$map$2$2(flowCollector), continuation);
