...
final class OriginalUnseenKeyguardCoordinator$trackUnseenFilterSettingChanges$2 extends SuspendLambda implements Function2 {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        bool.booleanValue();
        return ((OriginalUnseenKeyguardCoordinator$trackUnseenFilterSettingChanges$2) create(bool, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (z != originalUnseenKeyguardCoordinator.unseenFilterEnabled) {
                originalUnseenKeyguardCoordinator.unseenFilterEnabled = z;
                originalUnseenKeyguardCoordinator.unseenNotifFilter.invalidateList("unseen setting changed");
            }
            if (z) {
                OriginalUnseenKeyguardCoordinator originalUnseenKeyguardCoordinator2 = this.this$0;
                this.label = 1;
                final Flow flow = originalUnseenKeyguardCoordinator2.keyguardTransitionInteractor.transitions;
                ...
                }), new OriginalUnseenKeyguardCoordinator$trackSeenNotifications$isKeyguardPresentFlow$3(originalUnseenKeyguardCoordinator2, null), 0), new OriginalUnseenKeyguardCoordinator$trackSeenNotifications$2(originalUnseenKeyguardCoordinator2, new LinkedHashSet(), null), this);
