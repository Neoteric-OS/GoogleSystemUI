...
public final class CastToOtherDeviceChipViewModel {
    ...
    public CastToOtherDeviceChipViewModel(CoroutineScope coroutineScope, Context context, MediaProjectionChipInteractor mediaProjectionChipInteractor, MediaRouterChipInteractor mediaRouterChipInteractor, SystemClock systemClock, DialogTransitionAnimator dialogTransitionAnimator, EndMediaProjectionDialogHelper endMediaProjectionDialogHelper, LogBuffer logBuffer) {
        ...
        final int i = 0;
        ReadonlyStateFlow stateIn = FlowKt.stateIn(new Flow() { // from class: com.android.systemui.statusbar.chips.casttootherdevice.ui.viewmodel.CastToOtherDeviceChipViewModel$special$$inlined$map$1
            ...
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                switch (i) {
                    case 0:
                        ...
                        break;
                    default:
                        readonlyStateFlow.collect(new CastToOtherDeviceChipViewModel$special$$inlined$map$2$2(flowCollector, this), continuation);
                        break;
                }
        ...
        final int i2 = 1;
        ReadonlyStateFlow stateIn2 = FlowKt.stateIn(new FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(stateIn, FlowKt.stateIn(new Flow() { // from class: com.android.systemui.statusbar.chips.casttootherdevice.ui.viewmodel.CastToOtherDeviceChipViewModel$special$$inlined$map$1
            ...
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                switch (i2) {
                    case 0:
                        readonlyStateFlow2.collect(new AnonymousClass2(flowCollector, this), continuation);
                        break;
                    default:
                        readonlyStateFlow2.collect(new CastToOtherDeviceChipViewModel$special$$inlined$map$2$2(flowCollector, this), continuation);
                        break;
                }
                return CoroutineSingletons.COROUTINE_SUSPENDED;
            }
        }, coroutineScope, SharingStarted.Companion.WhileSubscribed$default(3), new OngoingActivityChipModel.Hidden(true)), new CastToOtherDeviceChipViewModel$internalChip$1(this, null)), coroutineScope, SharingStarted.Companion.WhileSubscribed$default(3), new OngoingActivityChipModel.Hidden(true));
