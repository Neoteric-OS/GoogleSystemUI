...
public final class DeviceBasedSatelliteInteractor$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ DeviceBasedSatelliteInteractor$special$$inlined$map$1(int i, Object obj) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                Object collect2 = ((StateFlow) this.$this_unsafeTransform$inlined).collect(new DeviceBasedSatelliteInteractor$special$$inlined$aggregateOver$1$2(flowCollector), continuation);
            ...
            default:
                ...
                Object combineInternal = CombineKt.combineInternal(continuation, new Function0() { // from class: com.android.systemui.statusbar.pipeline.satellite.domain.interactor.DeviceBasedSatelliteInteractor$special$$inlined$aggregateOver$2$1$2
                ...
                }, new DeviceBasedSatelliteInteractor$special$$inlined$aggregateOver$2$1$3(3, null), flowCollector, flowArr);
