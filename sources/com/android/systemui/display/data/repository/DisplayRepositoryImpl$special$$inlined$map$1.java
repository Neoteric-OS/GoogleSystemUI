...
public final class DisplayRepositoryImpl$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ DisplayRepositoryImpl$special$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((DisplayRepositoryImpl$special$$inlined$map$4) this.$this_unsafeTransform$inlined).collect(new AnonymousClass2(flowCollector), continuation);
                if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 1:
                Object collect2 = ((DisplayRepositoryImpl$special$$inlined$map$2) this.$this_unsafeTransform$inlined).collect(new DisplayRepositoryImpl$mapElementsLazily$$inlined$map$1$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = ((DisplayRepositoryImpl$special$$inlined$map$1) this.$this_unsafeTransform$inlined).collect(new DisplayRepositoryImpl$special$$inlined$filter$1$2(flowCollector), continuation);
