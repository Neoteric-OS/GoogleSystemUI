...
public final class DisplayRepositoryImpl$special$$inlined$map$4 implements Flow {
    ...
    public /* synthetic */ DisplayRepositoryImpl$special$$inlined$map$4(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new DisplayRepositoryImpl$special$$inlined$filterIsInstance$1$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = this.$this_unsafeTransform$inlined.collect(new DisplayRepositoryImpl$special$$inlined$filterIsInstance$2$2(flowCollector), continuation);
