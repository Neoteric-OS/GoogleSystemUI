...
public final class DisplayRepositoryImpl$special$$inlined$map$2 implements Flow {
    ...
    public /* synthetic */ DisplayRepositoryImpl$special$$inlined$map$2(Flow flow, Object obj, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((DisplayRepositoryImpl$special$$inlined$map$4) this.$this_unsafeTransform$inlined).collect(new AnonymousClass2(flowCollector, (DisplayRepositoryImpl) this.this$0), continuation);
                if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 1:
                Object collect2 = ((FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1) this.$this_unsafeTransform$inlined).collect(new DisplayRepositoryImpl$mapElementsLazily$$inlined$filter$1$2(flowCollector, (DisplayRepositoryImpl$mapElementsLazily$State) this.this$0), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 2:
                ((ReadonlyStateFlow) this.$this_unsafeTransform$inlined).collect(new DisplayRepositoryImpl$special$$inlined$map$3$2(flowCollector, (DisplayRepositoryImpl) this.this$0), continuation);
                break;
            case 3:
                Object collect3 = this.$this_unsafeTransform$inlined.collect(new DisplayRepositoryImpl$special$$inlined$map$5$2(flowCollector, (DisplayRepositoryImpl) this.this$0), continuation);
                if (collect3 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect4 = ((DisplayRepositoryImpl$special$$inlined$map$1) this.$this_unsafeTransform$inlined).collect(new DisplayRepositoryImpl$special$$inlined$map$6$2(flowCollector, (DisplayRepositoryImpl) this.this$0), continuation);
