...
public final class MediaDeviceSessionInteractor$playbackInfo$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ MediaDeviceSessionInteractor$playbackInfo$$inlined$map$1(FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1 flowKt__TransformKt$onEach$$inlined$unsafeTransform$1, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            default:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new MediaDeviceSessionInteractor$playbackState$$inlined$map$1$2(flowCollector), continuation);
