...
public final class AncViewModel$special$$inlined$filterIsInstance$1 implements Flow {
    ...
    public /* synthetic */ AncViewModel$special$$inlined$filterIsInstance$1(ReadonlyStateFlow readonlyStateFlow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            default:
                this.$this_unsafeTransform$inlined.collect(new AncViewModel$special$$inlined$filterIsInstance$2$2(flowCollector), continuation);
                break;
        }
