...
public final class AudioOutputInteractor {
    ...
    public AudioOutputInteractor(Context context, AudioRepository audioRepository, AudioModeInteractor audioModeInteractor, ContextScope contextScope, CoroutineContext coroutineContext, LocalBluetoothManager localBluetoothManager, BluetoothAdapter bluetoothAdapter, DeviceIconInteractor deviceIconInteractor, MediaOutputInteractor mediaOutputInteractor) {
        ...
        this.currentAudioDevice = FlowKt.stateIn(FlowKt.flowOn(new Flow() { // from class: com.android.systemui.volume.domain.interactor.AudioOutputInteractor$special$$inlined$map$1
        ...
        }, coroutineContext), contextScope, SharingStarted.Companion.Eagerly, AudioOutputDevice.Unavailable.INSTANCE);
    }
}
