...
public final class KeyguardSurfaceBehindInteractor {
    ...
    public final KeyguardSurfaceBehindRepositoryImpl repository;
    public final Flow viewParams;

    public KeyguardSurfaceBehindInteractor(KeyguardSurfaceBehindRepositoryImpl keyguardSurfaceBehindRepositoryImpl, Context context, KeyguardTransitionInteractor keyguardTransitionInteractor, Lazy lazy, SwipeToDismissInteractor swipeToDismissInteractor, NotificationLaunchAnimationInteractor notificationLaunchAnimationInteractor) {
        this.repository = keyguardSurfaceBehindRepositoryImpl;
        Edge.Companion companion = Edge.Companion;
        Edge.StateToScene create$default = Edge.Companion.create$default(Scenes.Gone);
        KeyguardState keyguardState = KeyguardState.GONE;
        Flow isInTransition = keyguardTransitionInteractor.isInTransition(create$default, Edge.Companion.create$default(null, keyguardState, 1));
        ...
        this.viewParams = FlowKt.distinctUntilChanged(FlowKt.combine(isInTransition, isFinishedIn, notificationLaunchAnimationRepository.isLaunchAnimationRunning, new KeyguardSurfaceBehindInteractor$viewParams$1(lazy, context, swipeToDismissInteractor, null)));
        final SafeFlow sample = com.android.systemui.util.kotlin.FlowKt.sample(notificationLaunchAnimationRepository.isLaunchAnimationRunning, keyguardTransitionInteractor.isFinishedIn(keyguardState), KeyguardSurfaceBehindInteractor$isNotificationLaunchAnimationRunningOnKeyguard$2.INSTANCE);
        this.isAnimatingSurface = new FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(keyguardSurfaceBehindRepositoryImpl.isAnimatingSurface, new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new KeyguardSurfaceBehindInteractor$isNotificationLaunchAnimationRunningOnKeyguard$4(2, null), new Flow() { // from class: com.android.systemui.keyguard.domain.interactor.KeyguardSurfaceBehindInteractor$special$$inlined$map$1
        ...
        }), new KeyguardSurfaceBehindInteractor$isAnimatingSurface$1(3, null));
    }
}
