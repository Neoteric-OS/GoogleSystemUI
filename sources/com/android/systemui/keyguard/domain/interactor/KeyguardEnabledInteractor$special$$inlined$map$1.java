...
public final class KeyguardEnabledInteractor$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ KeyguardEnabledInteractor$special$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                Object collect2 = ((StateFlow) this.$this_unsafeTransform$inlined).collect(new KeyguardEnabledInteractor$1$invokeSuspend$$inlined$filter$1$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = ((FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1) this.$this_unsafeTransform$inlined).collect(new KeyguardEnabledInteractor$special$$inlined$filter$1$2(flowCollector), continuation);
