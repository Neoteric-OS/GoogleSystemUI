...
public final class KeyguardInteractor$special$$inlined$map$2 implements Flow {
    ...
    public /* synthetic */ KeyguardInteractor$special$$inlined$map$2(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            ...
            case 1:
                ((StateFlowImpl) ((MutableStateFlow) this.$this_unsafeTransform$inlined)).collect(new KeyguardInteractor$special$$inlined$filter$1$2(flowCollector), continuation);
                return CoroutineSingletons.COROUTINE_SUSPENDED;
            default:
                Object collect2 = ((SafeFlow) this.$this_unsafeTransform$inlined).collect(new KeyguardInteractor$special$$inlined$filter$2$2(flowCollector), continuation);
