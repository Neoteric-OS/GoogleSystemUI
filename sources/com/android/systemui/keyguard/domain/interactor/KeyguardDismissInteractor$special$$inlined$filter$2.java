...
public final class KeyguardDismissInteractor$special$$inlined$filter$2 implements Flow {
    ...
    public final class AnonymousClass2 implements FlowCollector {
        ...
        */
        public final java.lang.Object emit(java.lang.Object r5, kotlin.coroutines.Continuation r6) {
            /*
                r4 = this;
                boolean r0 = r6 instanceof com.android.systemui.keyguard.domain.interactor.KeyguardDismissInteractor$special$$inlined$filter$2.AnonymousClass2.AnonymousClass1
                if (r0 == 0) goto L13
                r0 = r6
    ...
    public /* synthetic */ KeyguardDismissInteractor$special$$inlined$filter$2(Flow flow, KeyguardDismissInteractor keyguardDismissInteractor, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((ReadonlySharedFlow) this.$this_unsafeTransform$inlined).$$delegate_0.collect(new AnonymousClass2(flowCollector, this.this$0), continuation);
                if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect2 = ((FlowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1) this.$this_unsafeTransform$inlined).collect(new KeyguardDismissInteractor$special$$inlined$filter$3$2(flowCollector, this.this$0), continuation);
