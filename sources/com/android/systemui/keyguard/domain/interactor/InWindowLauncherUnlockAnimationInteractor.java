...
public final class InWindowLauncherUnlockAnimationInteractor {
    ...
    public InWindowLauncherUnlockAnimationInteractor(InWindowLauncherUnlockAnimationRepository inWindowLauncherUnlockAnimationRepository, CoroutineScope coroutineScope, KeyguardTransitionInteractor keyguardTransitionInteractor, Lazy lazy, ActivityManagerWrapper activityManagerWrapper) {
        ...
        this.startedUnlockAnimation = new ReadonlyStateFlow(inWindowLauncherUnlockAnimationRepository.startedUnlockAnimation);
        Edge.Companion companion = Edge.Companion;
        final Flow isInTransition = keyguardTransitionInteractor.isInTransition(Edge.Companion.create$default(Scenes.Gone), Edge.Companion.create$default(null, KeyguardState.GONE, 1));
        ...
        this.shouldStartInWindowAnimation = FlowKt.stateIn(new FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(stateIn, ((KeyguardSurfaceBehindRepositoryImpl) lazy.get()).isSurfaceRemoteAnimationTargetAvailable, new InWindowLauncherUnlockAnimationInteractor$shouldStartInWindowAnimation$1(3, null)), coroutineScope, startedEagerly, bool);
    }
