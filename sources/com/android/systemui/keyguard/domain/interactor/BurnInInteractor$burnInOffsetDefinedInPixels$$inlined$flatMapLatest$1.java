...
public final class BurnInInteractor$burnInOffsetDefinedInPixels$$inlined$flatMapLatest$1 extends SuspendLambda implements Function3 {
    ...
    public BurnInInteractor$burnInOffsetDefinedInPixels$$inlined$flatMapLatest$1(int i, BurnInInteractor burnInInteractor, Continuation continuation, boolean z) {
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        BurnInInteractor$burnInOffsetDefinedInPixels$$inlined$flatMapLatest$1 burnInInteractor$burnInOffsetDefinedInPixels$$inlined$flatMapLatest$1 = new BurnInInteractor$burnInOffsetDefinedInPixels$$inlined$flatMapLatest$1(this.$maxBurnInOffsetResourceId$inlined, burnInInteractor, (Continuation) obj3, this.$isXAxis$inlined);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            BurnInInteractor burnInInteractor = this.this$0;
            ChannelFlowTransformLatest mapLatest = FlowKt.mapLatest(new BurnInInteractor$burnInOffsetDefinedInPixels$1$1(burnInInteractor, dimensionPixelSize, this.$isXAxis$inlined, floatValue, null), burnInInteractor.keyguardInteractor.dozeTimeTick);
            this.label = 1;
