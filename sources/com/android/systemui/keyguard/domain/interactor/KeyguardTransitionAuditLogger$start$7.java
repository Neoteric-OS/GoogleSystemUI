...
final class KeyguardTransitionAuditLogger$start$7 extends SuspendLambda implements Function2 {
    ...
    public KeyguardTransitionAuditLogger$start$7(KeyguardTransitionAuditLogger keyguardTransitionAuditLogger, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            SafeFlow safeFlow = keyguardTransitionAuditLogger.keyguardInteractor.alternateBouncerShowing;
            KeyguardTransitionAuditLogger$start$1.AnonymousClass1 anonymousClass1 = new KeyguardTransitionAuditLogger$start$1.AnonymousClass1(keyguardTransitionAuditLogger, 17);
            this.label = 1;
