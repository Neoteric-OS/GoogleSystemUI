...
public final class KeyguardTransitionInteractor$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ KeyguardTransitionInteractor$special$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        ...
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((KeyguardTransitionInteractor$special$$inlined$filter$2) flow).collect(new AnonymousClass2(flowCollector), continuation);
            ...
            case 1:
                ...
                ((ReadonlyStateFlow) flow).collect(new KeyguardTransitionInteractor$isCurrentlyIn$$inlined$map$1$2(flowCollector), continuation);
                return CoroutineSingletons.COROUTINE_SUSPENDED;
            default:
                Object collect2 = ((SafeFlow) flow).collect(new KeyguardTransitionInteractor$special$$inlined$filter$1$2(flowCollector), continuation);
                return collect2 == CoroutineSingletons.COROUTINE_SUSPENDED ? collect2 : unit;
        }
    }

    public KeyguardTransitionInteractor$special$$inlined$map$1(ReadonlyStateFlow readonlyStateFlow) {
        this.$r8$classId = 1;
        KeyguardState.Companion companion = KeyguardState.Companion;
