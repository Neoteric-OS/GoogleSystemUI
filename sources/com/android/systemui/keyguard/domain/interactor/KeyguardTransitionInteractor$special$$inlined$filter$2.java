...
public final class KeyguardTransitionInteractor$special$$inlined$filter$2 implements Flow {
    ...
    public /* synthetic */ KeyguardTransitionInteractor$special$$inlined$filter$2(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new KeyguardTransitionInteractor$isInTransitionWhere$$inlined$filter$1$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = this.$this_unsafeTransform$inlined.collect(new KeyguardTransitionInteractor$special$$inlined$filter$3$2(flowCollector), continuation);
