...
final class KeyguardTransitionAuditLogger$start$3 extends SuspendLambda implements Function2 {
    ...
    public KeyguardTransitionAuditLogger$start$3(KeyguardTransitionAuditLogger keyguardTransitionAuditLogger, Continuation continuation) {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ((KeyguardTransitionAuditLogger$start$3) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ReadonlyStateFlow readonlyStateFlow = ((ShadeInteractorImpl) keyguardTransitionAuditLogger.shadeInteractor).isUserInteracting;
        KeyguardTransitionAuditLogger$start$1.AnonymousClass1 anonymousClass1 = new KeyguardTransitionAuditLogger$start$1.AnonymousClass1(keyguardTransitionAuditLogger, 13);
        this.label = 1;
