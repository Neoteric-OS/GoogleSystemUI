...
public final class KeyguardClockInteractor {
    ...
    public final KeyguardClockRepositoryImpl keyguardClockRepository;
    ...
    public KeyguardClockInteractor(KeyguardInteractor keyguardInteractor, KeyguardTransitionInteractor keyguardTransitionInteractor, CoroutineScope coroutineScope, KeyguardClockRepositoryImpl keyguardClockRepositoryImpl) {
        this.keyguardClockRepository = keyguardClockRepositoryImpl;
        final ReadonlyStateFlow readonlyStateFlow = keyguardTransitionInteractor.currentKeyguardState;
        new Flow() { // from class: com.android.systemui.keyguard.domain.interactor.KeyguardClockInteractor$special$$inlined$map$1
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final java.lang.Object emit(java.lang.Object r5, kotlin.coroutines.Continuation r6) {
                    /*
                        r4 = this;
                        boolean r0 = r6 instanceof com.android.systemui.keyguard.domain.interactor.KeyguardClockInteractor$special$$inlined$map$1.AnonymousClass2.AnonymousClass1
                        if (r0 == 0) goto L13
                        r0 = r6
                        com.android.systemui.keyguard.domain.interactor.KeyguardClockInteractor$special$$inlined$map$1$2$1 r0 = (com.android.systemui.keyguard.domain.interactor.KeyguardClockInteractor$special$$inlined$map$1.AnonymousClass2.AnonymousClass1) r0
                        int r1 = r0.label
                        ...
                        goto L18
                    L13:
                        com.android.systemui.keyguard.domain.interactor.KeyguardClockInteractor$special$$inlined$map$1$2$1 r0 = new com.android.systemui.keyguard.domain.interactor.KeyguardClockInteractor$special$$inlined$map$1$2$1
                        r0.<init>(r6)
                    L18:
                    ...
                    L4a:
                        ...
                        return r4
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.keyguard.domain.interactor.KeyguardClockInteractor$special$$inlined$map$1.AnonymousClass2.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
                }
            }
        ...
        this.selectedClockSize = keyguardClockRepositoryImpl.selectedClockSize;
        ...
        this.clock$receiver = keyguardClockRepositoryImpl.clockEventController;
        this.clockSize = keyguardClockRepositoryImpl.clockSize;
        this.clockShouldBeCentered = keyguardInteractor.clockShouldBeCentered;
    }
}
