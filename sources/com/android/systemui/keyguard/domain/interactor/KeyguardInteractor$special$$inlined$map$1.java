...
public final class KeyguardInteractor$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ KeyguardInteractor$special$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            default:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new KeyguardInteractor$topClippingBounds$2$invoke$$inlined$map$1$2(flowCollector), continuation);
