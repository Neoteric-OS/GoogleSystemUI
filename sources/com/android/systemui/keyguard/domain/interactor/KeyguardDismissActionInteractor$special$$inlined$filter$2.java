...
public final class KeyguardDismissActionInteractor$special$$inlined$filter$2 implements Flow {
    ...
    public /* synthetic */ KeyguardDismissActionInteractor$special$$inlined$filter$2(SafeFlow safeFlow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            default:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new KeyguardDismissActionInteractor$special$$inlined$filterNot$1$2(flowCollector), continuation);
