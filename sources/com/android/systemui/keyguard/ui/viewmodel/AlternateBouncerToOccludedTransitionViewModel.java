...
public final class AlternateBouncerToOccludedTransitionViewModel implements DeviceEntryIconTransition {
    ...
    public AlternateBouncerToOccludedTransitionViewModel(KeyguardTransitionAnimationFlow keyguardTransitionAnimationFlow) {
        long j = FromAlternateBouncerTransitionInteractor.TO_OCCLUDED_DURATION;
        Edge.Companion companion = Edge.Companion;
        KeyguardTransitionAnimationFlow.FlowBuilder flowBuilder = keyguardTransitionAnimationFlow.new FlowBuilder(j, AlternateBouncerToAodTransitionViewModel$$ExternalSyntheticOutline0.m(KeyguardState.ALTERNATE_BOUNCER, KeyguardState.OCCLUDED, keyguardTransitionAnimationFlow));
