...
public final class DreamingToAodTransitionViewModel implements DeviceEntryIconTransition {
    ...
    public DreamingToAodTransitionViewModel(DeviceEntryUdfpsInteractor deviceEntryUdfpsInteractor, KeyguardTransitionAnimationFlow keyguardTransitionAnimationFlow) {
        long j = FromDreamingTransitionInteractor.TO_AOD_DURATION;
        Edge.Companion companion = Edge.Companion;
        KeyguardTransitionAnimationFlow.FlowBuilder flowBuilder = keyguardTransitionAnimationFlow.new FlowBuilder(j, AlternateBouncerToAodTransitionViewModel$$ExternalSyntheticOutline0.m(KeyguardState.DREAMING, KeyguardState.AOD, keyguardTransitionAnimationFlow));
        this.transitionAnimation = flowBuilder;
        int i = Duration.$r8$clinit;
        this.lockscreenAlpha = KeyguardTransitionAnimationFlow.FlowBuilder.m825sharedFlow74qcysc$default(flowBuilder, DurationKt.toDuration(300, DurationUnit.MILLISECONDS), new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.DreamingToAodTransitionViewModel$lockscreenAlpha$1
