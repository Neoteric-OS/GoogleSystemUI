...
public final class GlanceableHubToDreamingTransitionViewModel implements DeviceEntryIconTransition {
    ...
    /* JADX WARN: Type inference failed for: r5v4, types: [com.android.systemui.keyguard.ui.viewmodel.GlanceableHubToDreamingTransitionViewModel$special$$inlined$map$1] */
    public GlanceableHubToDreamingTransitionViewModel(ConfigurationInteractor configurationInteractor, KeyguardTransitionAnimationFlow keyguardTransitionAnimationFlow) {
        ...
        Edge.StateToState stateToState = new Edge.StateToState(KeyguardState.GLANCEABLE_HUB, keyguardState);
        ...
        this.dreamOverlayAlpha = KeyguardTransitionAnimationFlow.FlowBuilder.m825sharedFlow74qcysc$default(flowBuilder, DurationKt.toDuration(167, durationUnit), new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.GlanceableHubToDreamingTransitionViewModel$dreamOverlayAlpha$1
        ...
        this.dreamOverlayTranslationX = FlowKt.transformLatest(configurationInteractor.directionalDimensionPixelSize(R.dimen.hub_to_dreaming_transition_dream_overlay_translation_x), new GlanceableHubToDreamingTransitionViewModel$special$$inlined$flatMapLatest$1(null, this));
        ...
        this.deviceEntryParentViewAlpha = KeyguardTransitionAnimationFlow.FlowBuilder.m825sharedFlow74qcysc$default(flowBuilder, DurationKt.toDuration(167, durationUnit), new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.GlanceableHubToDreamingTransitionViewModel$deviceEntryParentViewAlpha$1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
