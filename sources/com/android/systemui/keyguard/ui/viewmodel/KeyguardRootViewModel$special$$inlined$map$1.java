...
public final class KeyguardRootViewModel$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ KeyguardRootViewModel$special$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((KeyguardRootViewModel$special$$inlined$map$4) this.$this_unsafeTransform$inlined).collect(new AnonymousClass2(flowCollector), continuation);
                if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect2 = ((SafeFlow) this.$this_unsafeTransform$inlined).collect(new KeyguardRootViewModel$isPulseExpandingAnimated$$inlined$map$1$2(flowCollector), continuation);
