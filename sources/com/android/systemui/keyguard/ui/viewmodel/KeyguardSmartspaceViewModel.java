...
public final class KeyguardSmartspaceViewModel {
    ...
    public KeyguardSmartspaceViewModel(CoroutineScope coroutineScope, LockscreenSmartspaceController lockscreenSmartspaceController, KeyguardClockViewModel keyguardClockViewModel, KeyguardSmartspaceInteractor keyguardSmartspaceInteractor) {
        ...
        FlowKt.stateIn(new Flow() { // from class: com.android.systemui.keyguard.ui.viewmodel.KeyguardSmartspaceViewModel$special$$inlined$map$1
        ...
        }, coroutineScope, SharingStarted.Companion.WhileSubscribed$default(3), Boolean.valueOf(!((Boolean) ((StateFlowImpl) readonlyStateFlow2.$$delegate_0).getValue()).booleanValue()));
        this.isWeatherVisible = FlowKt.stateIn(new FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(readonlyStateFlow, readonlyStateFlow2, new KeyguardSmartspaceViewModel$isWeatherVisible$1(this, null)), coroutineScope, SharingStarted.Companion.WhileSubscribed$default(3), Boolean.valueOf(!((Boolean) ((StateFlowImpl) readonlyStateFlow2.$$delegate_0).getValue()).booleanValue() && ((Boolean) ((StateFlowImpl) readonlyStateFlow.$$delegate_0).getValue()).booleanValue()));
