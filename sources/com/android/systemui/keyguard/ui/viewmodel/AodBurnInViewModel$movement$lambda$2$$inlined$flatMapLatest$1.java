...
public final class AodBurnInViewModel$movement$lambda$2$$inlined$flatMapLatest$1 extends SuspendLambda implements Function3 {
    ...
    public AodBurnInViewModel$movement$lambda$2$$inlined$flatMapLatest$1(AodBurnInViewModel aodBurnInViewModel, BurnInParameters burnInParameters, Continuation continuation) {
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        AodBurnInViewModel$movement$lambda$2$$inlined$flatMapLatest$1 aodBurnInViewModel$movement$lambda$2$$inlined$flatMapLatest$1 = new AodBurnInViewModel$movement$lambda$2$$inlined$flatMapLatest$1(this.this$0, this.$params$inlined, (Continuation) obj3);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new AodBurnInViewModel$movement$1$1$1(2, null), this.this$0.keyguardInteractor.keyguardTranslationY);
            ...
            final MutableSharedFlow transitionValueFlow = aodBurnInViewModel.keyguardTransitionInteractor.getTransitionValueFlow(KeyguardState.AOD);
            FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$12 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new AodBurnInViewModel$movement$1$1$2(2, null), new FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(new Flow() { // from class: com.android.systemui.keyguard.ui.viewmodel.AodBurnInViewModel$burnIn$$inlined$map$1
                ...
                public final Object collect(FlowCollector flowCollector2, Continuation continuation) {
                    Object collect = MutableSharedFlow.this.collect(new AnonymousClass2(flowCollector2), continuation);
            ...
            long duration = DurationKt.toDuration(600, durationUnit);
            ...
            FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$13 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new AodBurnInViewModel$movement$1$1$3(2, null), new SafeFlow(new GoneToAodTransitionViewModel$enterFromTopTranslationY$$inlined$transform$1(FlowKt.sample(KeyguardTransitionAnimationFlow.FlowBuilder.m826sharedFlowWithState74qcysc$default(goneToAodTransitionViewModel.transitionAnimation, duration2, function1, duration, null, null, goneToAodTransitionViewModel$enterFromTopTranslationY$2, interpolator, null, 152), goneToAodTransitionViewModel.powerInteractor.detailedWakefulness, GoneToAodTransitionViewModel$enterFromTopTranslationY$4.INSTANCE), null)));
            ...
            FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$14 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new AodBurnInViewModel$movement$1$1$4(2, null), new SafeFlow(new GoneToAodTransitionViewModel$enterFromSideTranslationX$$inlined$transform$1(FlowKt.sample(KeyguardTransitionAnimationFlow.FlowBuilder.m826sharedFlowWithState74qcysc$default(goneToAodTransitionViewModel2.transitionAnimation, DurationKt.toDuration(600, durationUnit), new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.GoneToAodTransitionViewModel$enterFromSideTranslationX$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
            ...
            }, duration3, null, null, new Function0() { // from class: com.android.systemui.keyguard.ui.viewmodel.GoneToAodTransitionViewModel$enterFromSideTranslationX$2
                @Override // kotlin.jvm.functions.Function0
                public final /* bridge */ /* synthetic */ Object invoke() {
                    return Float.valueOf(0.0f);
                }
            }, interpolator, null, 152), goneToAodTransitionViewModel2.powerInteractor.detailedWakefulness, GoneToAodTransitionViewModel$enterFromSideTranslationX$4.INSTANCE), null)));
            ...
            long duration4 = DurationKt.toDuration(600, durationUnit);
            FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$15 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new AodBurnInViewModel$movement$1$1$5(2, null), new SafeFlow(new LockscreenToAodTransitionViewModel$enterFromSideTranslationX$$inlined$transform$1(FlowKt.sample(KeyguardTransitionAnimationFlow.FlowBuilder.m826sharedFlowWithState74qcysc$default(lockscreenToAodTransitionViewModel.transitionAnimationOnFold, DurationKt.toDuration(500, durationUnit), new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.LockscreenToAodTransitionViewModel$enterFromSideTranslationX$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
            ...
            }, duration4, null, null, new Function0() { // from class: com.android.systemui.keyguard.ui.viewmodel.LockscreenToAodTransitionViewModel$enterFromSideTranslationX$2
                @Override // kotlin.jvm.functions.Function0
                public final /* bridge */ /* synthetic */ Object invoke() {
                    return Float.valueOf(0.0f);
                }
            }, interpolator, null, 152), lockscreenToAodTransitionViewModel.powerInteractor.detailedWakefulness, LockscreenToAodTransitionViewModel$enterFromSideTranslationX$4.INSTANCE), null)));
            FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$16 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new AodBurnInViewModel$movement$1$1$6(2, null), this.this$0.occludedToLockscreenTransitionViewModel.lockscreenTranslationY);
            ...
            final Flow[] flowArr = {flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1, flowKt__EmittersKt$onStart$$inlined$unsafeFlow$12, flowKt__EmittersKt$onStart$$inlined$unsafeFlow$13, flowKt__EmittersKt$onStart$$inlined$unsafeFlow$14, flowKt__EmittersKt$onStart$$inlined$unsafeFlow$15, flowKt__EmittersKt$onStart$$inlined$unsafeFlow$16, new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new AodBurnInViewModel$movement$1$1$7(2, null), KeyguardTransitionAnimationFlow.FlowBuilder.m826sharedFlowWithState74qcysc$default(aodToLockscreenTransitionViewModel.transitionAnimation, DurationKt.toDuration(500, durationUnit), new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.AodToLockscreenTransitionViewModel$translationY$1
                ...
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj5) {
                    return Float.valueOf(MathUtils.lerp(Ref$FloatRef.this.element, 0.0f, ((PathInterpolator) Interpolators.FAST_OUT_SLOW_IN).getInterpolation(((Number) obj5).floatValue())));
                }
            ...
            Object combineInternal = CombineKt.combineInternal(this, new Function0() { // from class: com.android.systemui.keyguard.ui.viewmodel.AodBurnInViewModel$movement$lambda$2$lambda$1$$inlined$combine$1$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
            ...
            }, new AodBurnInViewModel$movement$lambda$2$lambda$1$$inlined$combine$1$3(3, null), flowCollector, flowArr);
