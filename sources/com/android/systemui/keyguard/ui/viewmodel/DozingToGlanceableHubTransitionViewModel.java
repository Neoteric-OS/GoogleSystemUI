...
public final class DozingToGlanceableHubTransitionViewModel implements DeviceEntryIconTransition {
    public final KeyguardTransitionAnimationFlow$FlowBuilder$sharedFlow74qcysc$$inlined$mapNotNull$1 deviceEntryParentViewAlpha;
    public final FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2 notificationAlpha;

    public DozingToGlanceableHubTransitionViewModel(KeyguardTransitionAnimationFlow keyguardTransitionAnimationFlow) {
        ...
        this.deviceEntryParentViewAlpha = keyguardTransitionAnimationFlow.new FlowBuilder(j, new Edge.StateToState(keyguardState, KeyguardState.GLANCEABLE_HUB)).immediatelyTransitionTo(1.0f);
