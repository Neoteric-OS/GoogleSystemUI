...
public final class KeyguardRootViewModel$special$$inlined$map$4 implements Flow {
    ...
    public /* synthetic */ KeyguardRootViewModel$special$$inlined$map$4(ReadonlyStateFlow readonlyStateFlow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                this.$this_unsafeTransform$inlined.collect(new KeyguardRootViewModel$special$$inlined$filter$1$2(flowCollector), continuation);
                break;
            case 2:
                this.$this_unsafeTransform$inlined.collect(new KeyguardRootViewModel$special$$inlined$map$5$2(flowCollector), continuation);
                break;
            default:
                this.$this_unsafeTransform$inlined.collect(new KeyguardRootViewModel$special$$inlined$map$6$2(flowCollector), continuation);
                break;
        }
