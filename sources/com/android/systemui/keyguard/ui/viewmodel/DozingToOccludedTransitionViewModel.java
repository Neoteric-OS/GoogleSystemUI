...
public final class DozingToOccludedTransitionViewModel implements DeviceEntryIconTransition {
    ...
    public DozingToOccludedTransitionViewModel(KeyguardTransitionAnimationFlow keyguardTransitionAnimationFlow) {
        ...
        KeyguardTransitionAnimationFlow.FlowBuilder flowBuilder = keyguardTransitionAnimationFlow.new FlowBuilder(j, AlternateBouncerToAodTransitionViewModel$$ExternalSyntheticOutline0.m(KeyguardState.DOZING, KeyguardState.OCCLUDED, keyguardTransitionAnimationFlow));
    ...
    public final Flow lockscreenAlpha(final ViewStateAccessor viewStateAccessor) {
        ...
        return KeyguardTransitionAnimationFlow.FlowBuilder.m825sharedFlow74qcysc$default(this.transitionAnimation, duration, new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.DozingToOccludedTransitionViewModel$lockscreenAlpha$1
            {
                super(1);
            }
        ...
        }, duration2, new Function0() { // from class: com.android.systemui.keyguard.ui.viewmodel.DozingToOccludedTransitionViewModel$lockscreenAlpha$2
