...
public final class LockscreenToDozingTransitionViewModel implements DeviceEntryIconTransition {
    ...
    public LockscreenToDozingTransitionViewModel(DeviceEntryUdfpsInteractor deviceEntryUdfpsInteractor, KeyguardTransitionAnimationFlow keyguardTransitionAnimationFlow) {
        ...
        KeyguardTransitionAnimationFlow.FlowBuilder flowBuilder = keyguardTransitionAnimationFlow.new FlowBuilder(j, AlternateBouncerToAodTransitionViewModel$$ExternalSyntheticOutline0.m(KeyguardState.LOCKSCREEN, KeyguardState.DOZING, keyguardTransitionAnimationFlow));
        this.transitionAnimation = flowBuilder;
        this.lockscreenAlpha = flowBuilder.immediatelyTransitionTo(1.0f);
        int i = Duration.$r8$clinit;
        this.shortcutsAlpha = KeyguardTransitionAnimationFlow.FlowBuilder.m825sharedFlow74qcysc$default(flowBuilder, DurationKt.toDuration(250, DurationUnit.MILLISECONDS), new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.LockscreenToDozingTransitionViewModel$shortcutsAlpha$1
