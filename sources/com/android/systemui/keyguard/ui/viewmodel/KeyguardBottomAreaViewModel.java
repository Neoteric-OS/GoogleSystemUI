...
public final class KeyguardBottomAreaViewModel {
    ...
    public final class PreviewMode {
        ...
        public final boolean equals(Object obj) {
            ...
            if (obj instanceof PreviewMode) {
                return this.isInPreviewMode == ((PreviewMode) obj).isInPreviewMode;
            }
            return false;
        }

        public final int hashCode() {
            return Boolean.hashCode(false) + (Boolean.hashCode(this.isInPreviewMode) * 31);
        }

        public final String toString() {
            return AppCompatDelegateImpl$$ExternalSyntheticOutline0.m(new StringBuilder("PreviewMode(isInPreviewMode="), this.isInPreviewMode, ", shouldHighlightSelectedAffordance=false)");
        }
    }
    ...
    public KeyguardBottomAreaViewModel(KeyguardInteractor keyguardInteractor, KeyguardQuickAffordanceInteractor keyguardQuickAffordanceInteractor, KeyguardBottomAreaInteractor keyguardBottomAreaInteractor, BurnInHelperWrapper burnInHelperWrapper, KeyguardTouchHandlingViewModel keyguardTouchHandlingViewModel, KeyguardSettingsMenuViewModel keyguardSettingsMenuViewModel) {
        ...
        StateFlowImpl MutableStateFlow = StateFlowKt.MutableStateFlow(new PreviewMode(false));
        ...
        final int i = 2;
        this.areQuickAffordancesFullyOpaque = FlowKt.distinctUntilChanged(new Flow() { // from class: com.android.systemui.keyguard.ui.viewmodel.KeyguardBottomAreaViewModel$special$$inlined$map$2
            ...
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                switch (i) {
                    case 0:
                        ((ReadonlyStateFlow) stateFlow).collect(new AnonymousClass2(flowCollector), continuation);
                        return CoroutineSingletons.COROUTINE_SUSPENDED;
                    case 1:
                        ((ReadonlyStateFlow) stateFlow).collect(new KeyguardBottomAreaViewModel$special$$inlined$map$3$2(flowCollector), continuation);
                        return CoroutineSingletons.COROUTINE_SUSPENDED;
                    default:
                        Object collect = stateFlow.collect(new KeyguardBottomAreaViewModel$special$$inlined$map$1$2(flowCollector), continuation);
                        return collect == CoroutineSingletons.COROUTINE_SUSPENDED ? collect : Unit.INSTANCE;
                }
            }
        });
        FlowKt.transformLatest(MutableStateFlow, new KeyguardBottomAreaViewModel$button$$inlined$flatMapLatest$1(null, this, KeyguardQuickAffordancePosition.BOTTOM_START));
        FlowKt.transformLatest(MutableStateFlow, new KeyguardBottomAreaViewModel$button$$inlined$flatMapLatest$1(null, this, KeyguardQuickAffordancePosition.BOTTOM_END));
        final ReadonlyStateFlow readonlyStateFlow = keyguardInteractor.isDozing;
        final int i2 = 0;
        FlowKt.distinctUntilChanged(new Flow() { // from class: com.android.systemui.keyguard.ui.viewmodel.KeyguardBottomAreaViewModel$special$$inlined$map$2
            ...
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                switch (i2) {
                    case 0:
                        ...
                        return CoroutineSingletons.COROUTINE_SUSPENDED;
                    case 1:
                        ((ReadonlyStateFlow) readonlyStateFlow).collect(new KeyguardBottomAreaViewModel$special$$inlined$map$3$2(flowCollector), continuation);
                        return CoroutineSingletons.COROUTINE_SUSPENDED;
                    default:
                        Object collect = readonlyStateFlow.collect(new KeyguardBottomAreaViewModel$special$$inlined$map$1$2(flowCollector), continuation);
                        return collect == CoroutineSingletons.COROUTINE_SUSPENDED ? collect : Unit.INSTANCE;
                }
            }
        });
        ...
        final ReadonlyStateFlow readonlyStateFlow2 = keyguardBottomAreaInteractor.clockPosition;
        final int i3 = 1;
        FlowKt.distinctUntilChanged(new Flow() { // from class: com.android.systemui.keyguard.ui.viewmodel.KeyguardBottomAreaViewModel$special$$inlined$map$2
            ...
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                switch (i3) {
                    case 0:
                        ...
                        return CoroutineSingletons.COROUTINE_SUSPENDED;
                    case 1:
                        ((ReadonlyStateFlow) readonlyStateFlow2).collect(new KeyguardBottomAreaViewModel$special$$inlined$map$3$2(flowCollector), continuation);
                        return CoroutineSingletons.COROUTINE_SUSPENDED;
                    default:
                        Object collect = readonlyStateFlow2.collect(new KeyguardBottomAreaViewModel$special$$inlined$map$1$2(flowCollector), continuation);
                        return collect == CoroutineSingletons.COROUTINE_SUSPENDED ? collect : Unit.INSTANCE;
                }
            }
        });
