...
public final class KeyguardIndicationAreaViewModel$special$$inlined$map$2 implements Flow {
    ...
    public /* synthetic */ KeyguardIndicationAreaViewModel$special$$inlined$map$2(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new KeyguardIndicationAreaViewModel$indicationAreaTranslationY$$inlined$map$1$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = ((StateFlow) this.$this_unsafeTransform$inlined).collect(new KeyguardIndicationAreaViewModel$special$$inlined$map$1$2(flowCollector), continuation);
