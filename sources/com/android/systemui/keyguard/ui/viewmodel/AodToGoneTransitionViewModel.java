...
public final class AodToGoneTransitionViewModel implements DeviceEntryIconTransition {
    ...
    public final KeyguardTransitionAnimationFlow$FlowBuilder$sharedFlow74qcysc$$inlined$mapNotNull$1 notificationAlpha(final ViewStateAccessor viewStateAccessor) {
        ...
        return KeyguardTransitionAnimationFlow.FlowBuilder.m825sharedFlow74qcysc$default(this.transitionAnimation, DurationKt.toDuration(200, DurationUnit.MILLISECONDS), new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.AodToGoneTransitionViewModel$notificationAlpha$1
            {
                super(1);
            }
        ...
        }, 0L, new Function0() { // from class: com.android.systemui.keyguard.ui.viewmodel.AodToGoneTransitionViewModel$notificationAlpha$2
        ...
        }, null, new Function0() { // from class: com.android.systemui.keyguard.ui.viewmodel.AodToGoneTransitionViewModel$notificationAlpha$3
            @Override // kotlin.jvm.functions.Function0
