...
public final class OccludedToLockscreenTransitionViewModel$special$$inlined$filter$1 implements Flow {
    ...
    public OccludedToLockscreenTransitionViewModel$special$$inlined$filter$1(SafeFlow safeFlow, KeyguardTransitionInteractor keyguardTransitionInteractor) {
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new AnonymousClass2(flowCollector, this.$keyguardTransitionInteractor$inlined), continuation);
