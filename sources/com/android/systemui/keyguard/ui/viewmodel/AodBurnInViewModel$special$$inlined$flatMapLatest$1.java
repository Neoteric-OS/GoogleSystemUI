...
public final class AodBurnInViewModel$special$$inlined$flatMapLatest$1 extends SuspendLambda implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ChannelFlowTransformLatest transformLatest = FlowKt.transformLatest(this.this$0.configurationInteractor.dimensionPixelSize(SetsKt.setOf(new Integer(R.dimen.keyguard_enter_from_top_translation_y), new Integer(R.dimen.keyguard_enter_from_side_translation_x))), new AodBurnInViewModel$movement$lambda$2$$inlined$flatMapLatest$1(this.this$0, (BurnInParameters) this.L$1, null));
            this.label = 1;
