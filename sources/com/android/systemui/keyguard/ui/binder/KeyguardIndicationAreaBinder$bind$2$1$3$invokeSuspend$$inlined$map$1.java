...
public final class KeyguardIndicationAreaBinder$bind$2$1$3$invokeSuspend$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ KeyguardIndicationAreaBinder$bind$2$1$3$invokeSuspend$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            default:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new KeyguardIndicationAreaBinder$bind$2$1$4$invokeSuspend$$inlined$map$1$2(flowCollector), continuation);
