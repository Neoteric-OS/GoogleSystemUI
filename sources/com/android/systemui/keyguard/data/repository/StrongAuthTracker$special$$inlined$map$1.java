...
public final class StrongAuthTracker$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ StrongAuthTracker$special$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            default:
                Object collect2 = ((StrongAuthTracker$isNonStrongBiometricAllowed$lambda$6$$inlined$filter$1) this.$this_unsafeTransform$inlined).collect(new StrongAuthTracker$isNonStrongBiometricAllowed$lambda$6$$inlined$map$1$2(flowCollector), continuation);
