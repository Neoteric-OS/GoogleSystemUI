                ...
                public final void onBiometricRunningStateChanged(BiometricSourceType biometricSourceType, boolean z) {
                    if (biometricSourceType == BiometricSourceType.FINGERPRINT) {
                        ...
                        if (mo1790trySendJP2dKIU instanceof ChannelResult.Failed) {
                            Log.e("DeviceEntryFingerprintAuthRepositoryImpl", "Failed to send Fingerprint running state changed - downstream canceled or failed.", ChannelResult.m1791exceptionOrNullimpl(mo1790trySendJP2dKIU));
                        }
                    }
                }
            };
            this.this$0.keyguardUpdateMonitor.registerCallback(r1);
            Object mo1790trySendJP2dKIU = ((ProducerCoroutine) producerScope)._channel.mo1790trySendJP2dKIU(Boolean.valueOf(this.this$0.keyguardUpdateMonitor.isFingerprintDetectionRunning()));
            if (mo1790trySendJP2dKIU instanceof ChannelResult.Failed) {
                Log.e("DeviceEntryFingerprintAuthRepositoryImpl", "Failed to send Initial fingerprint running state - downstream canceled or failed.", ChannelResult.m1791exceptionOrNullimpl(mo1790trySendJP2dKIU));
            }
