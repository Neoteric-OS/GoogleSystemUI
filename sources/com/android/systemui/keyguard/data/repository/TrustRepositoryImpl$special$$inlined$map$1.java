...
public final class TrustRepositoryImpl$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ TrustRepositoryImpl$special$$inlined$map$1(FlowKt__ZipKt$combine$$inlined$unsafeFlow$1 flowKt__ZipKt$combine$$inlined$unsafeFlow$1, TrustRepositoryImpl trustRepositoryImpl, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new TrustRepositoryImpl$special$$inlined$map$2$2(flowCollector, this.this$0), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 2:
                Object collect3 = this.$this_unsafeTransform$inlined.collect(new TrustRepositoryImpl$special$$inlined$map$3$2(flowCollector, this.this$0), continuation);
                if (collect3 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect4 = this.$this_unsafeTransform$inlined.collect(new TrustRepositoryImpl$special$$inlined$map$5$2(flowCollector, this.this$0), continuation);
