...
final class KeyguardQuickAffordanceRemoteUserSelectionManager$userId$1 extends SuspendLambda implements Function2 {
    ...
    int label;
    final /* synthetic */ KeyguardQuickAffordanceRemoteUserSelectionManager this$0;

    /* compiled from: go/retraceme 97024faaf470985feb378c0f604e66d2eca678dbbb151206fad2ab4525fd6f86 */
    /* renamed from: com.android.systemui.keyguard.data.quickaffordance.KeyguardQuickAffordanceRemoteUserSelectionManager$userId$1$1, reason: invalid class name */
    ...
    public KeyguardQuickAffordanceRemoteUserSelectionManager$userId$1(KeyguardQuickAffordanceRemoteUserSelectionManager keyguardQuickAffordanceRemoteUserSelectionManager, Continuation continuation) {
    ...
    public final Object invoke(Object obj, Object obj2) {
        return ((KeyguardQuickAffordanceRemoteUserSelectionManager$userId$1) create((ProducerScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r1v1, types: [com.android.systemui.keyguard.data.quickaffordance.KeyguardQuickAffordanceRemoteUserSelectionManager$userId$1$callback$1, com.android.systemui.settings.UserTracker$Callback] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final ?? r1 = new UserTracker.Callback() { // from class: com.android.systemui.keyguard.data.quickaffordance.KeyguardQuickAffordanceRemoteUserSelectionManager$userId$1$callback$1
                ...
                public final void onUserChanged(int i2, Context context) {
                    ...
                    if (mo1790trySendJP2dKIU instanceof ChannelResult.Failed) {
                        FacePropertyRepositoryImpl$cameraInfo$1$callback$1$$ExternalSyntheticOutline0.m("Failed to send ", "updated state", " - downstream canceled or failed.", "KeyguardQuickAffordanceMultiUserSelectionManager", ChannelResult.m1791exceptionOrNullimpl(mo1790trySendJP2dKIU));
                    }
                }
            };
            ...
            Function0 function0 = new Function0() { // from class: com.android.systemui.keyguard.data.quickaffordance.KeyguardQuickAffordanceRemoteUserSelectionManager$userId$1.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
            ...
            this.label = 1;
            if (FlowTracing.tracedAwaitClose(producerScope, "userId", function0, this) == coroutineSingletons) {
