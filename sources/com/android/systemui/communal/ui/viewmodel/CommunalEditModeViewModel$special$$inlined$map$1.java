...
public final class CommunalEditModeViewModel$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ CommunalEditModeViewModel$special$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ((ReadonlyStateFlow) this.$this_unsafeTransform$inlined).collect(new AnonymousClass2(flowCollector), continuation);
                return CoroutineSingletons.COROUTINE_SUSPENDED;
            default:
                Object collect = this.$this_unsafeTransform$inlined.collect(new CommunalEditModeViewModel$special$$inlined$filter$1$2(flowCollector), continuation);
