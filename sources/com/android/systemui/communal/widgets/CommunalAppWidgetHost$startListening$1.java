...
final class CommunalAppWidgetHost$startListening$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invoke(Object obj, Object obj2) {
        CommunalAppWidgetHost$startListening$1 communalAppWidgetHost$startListening$1 = (CommunalAppWidgetHost$startListening$1) create((CoroutineScope) obj, (Continuation) obj2);
        Unit unit = Unit.INSTANCE;
        communalAppWidgetHost$startListening$1.invokeSuspend(unit);
        return unit;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        synchronized (communalAppWidgetHost.observers) {
            ...
            while (it.hasNext()) {
                ((CommunalWidgetHost) it.next()).refreshProviders();
            }
        }
