...
public final class CommunalSettingsRepositoryImpl$getEnabledByUser$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ CommunalSettingsRepositoryImpl$getEnabledByUser$$inlined$map$1(FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1, CommunalSettingsRepositoryImpl communalSettingsRepositoryImpl, UserInfo userInfo, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = this.$this_unsafeTransform$inlined.collect(new AnonymousClass2(flowCollector, this.this$0, this.$user$inlined), continuation);
                if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new CommunalSettingsRepositoryImpl$getAllowedByDevicePolicy$$inlined$map$1$2(flowCollector, this.this$0, this.$user$inlined), continuation);
