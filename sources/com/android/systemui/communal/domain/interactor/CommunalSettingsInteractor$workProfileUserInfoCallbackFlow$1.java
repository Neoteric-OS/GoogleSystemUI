...
final class CommunalSettingsInteractor$workProfileUserInfoCallbackFlow$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
                ...
                public final void onProfilesChanged(List list) {
                    ...
                    while (true) {
                        if (!it.hasNext()) {
                            ...
                            obj3 = it.next();
                            if (((UserInfo) obj3).isManagedProfile()) {
                                break;
                            }
                        }
                    }
                    ((ProducerCoroutine) ProducerScope.this).mo1790trySendJP2dKIU(obj3);
                }
            };
            ...
            Iterator it = ((UserTrackerImpl) this.this$0.userTracker).getUserProfiles().iterator();
            while (true) {
                if (!it.hasNext()) {
                    obj2 = null;
                    break;
            ...
            ((ProducerCoroutine) producerScope).mo1790trySendJP2dKIU(obj2);
