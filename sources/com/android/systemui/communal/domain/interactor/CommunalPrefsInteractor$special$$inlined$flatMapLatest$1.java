...
import com.android.systemui.communal.data.repository.CommunalPrefsRepositoryImpl$readKeyForUser$$inlined$flatMapLatest$1;
...
public final class CommunalPrefsInteractor$special$$inlined$flatMapLatest$1 extends SuspendLambda implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            CommunalPrefsRepositoryImpl communalPrefsRepositoryImpl = this.this$0.repository;
            Flow flowOn = FlowKt.flowOn(FlowKt.transformLatest(communalPrefsRepositoryImpl.backupRestorationEvents, new CommunalPrefsRepositoryImpl$readKeyForUser$$inlined$flatMapLatest$1(null, communalPrefsRepositoryImpl, userInfo, "cta_dismissed")), communalPrefsRepositoryImpl.bgDispatcher);
            this.label = 1;
