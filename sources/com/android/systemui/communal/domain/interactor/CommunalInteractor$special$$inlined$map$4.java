...
public final class CommunalInteractor$special$$inlined$map$4 implements Flow {
    ...
    public final class AnonymousClass2 implements FlowCollector {
        ...
        */
        public final java.lang.Object emit(java.lang.Object r5, kotlin.coroutines.Continuation r6) {
            /*
                r4 = this;
                boolean r0 = r6 instanceof com.android.systemui.communal.domain.interactor.CommunalInteractor$special$$inlined$map$4.AnonymousClass2.AnonymousClass1
                if (r0 == 0) goto L13
                r0 = r6
    ...
    public /* synthetic */ CommunalInteractor$special$$inlined$map$4(ReadonlyStateFlow readonlyStateFlow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                this.$this_unsafeTransform$inlined.collect(new CommunalInteractor$isCommunalShowing$lambda$6$$inlined$map$2$2(flowCollector), continuation);
                break;
            default:
                this.$this_unsafeTransform$inlined.collect(new CommunalInteractor$special$$inlined$filter$1$2(flowCollector), continuation);
                break;
        }
