...
import com.android.systemui.communal.domain.interactor.CommunalSceneTransitionInteractor$collectProgress$1;
...
final class CommunalSceneTransitionInteractor$listenForSceneTransitionProgress$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            SafeFlow pairwise = FlowKt.pairwise(this.this$0.sceneInteractor.transitionState, new ObservableTransitionState.Idle(CommunalScenes.Blank));
            CommunalSceneTransitionInteractor$collectProgress$1.AnonymousClass1 anonymousClass1 = new CommunalSceneTransitionInteractor$collectProgress$1.AnonymousClass1(this.this$0, 1);
            this.label = 1;
