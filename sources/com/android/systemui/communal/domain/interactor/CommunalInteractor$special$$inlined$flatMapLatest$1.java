...
public final class CommunalInteractor$special$$inlined$flatMapLatest$1 extends SuspendLambda implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow communalInteractor$special$$inlined$map$2 = ((Boolean) this.L$1).booleanValue() ? new CommunalInteractor$special$$inlined$map$2(this.$sceneInteractor$inlined.currentScene, 1) : new CommunalInteractor$special$$inlined$map$4(this.this$0.desiredScene, 1);
            this.label = 1;
            if (FlowKt.emitAll(flowCollector, communalInteractor$special$$inlined$map$2, this) == coroutineSingletons) {
