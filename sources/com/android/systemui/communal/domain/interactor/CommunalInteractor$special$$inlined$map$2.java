...
public final class CommunalInteractor$special$$inlined$map$2 implements Flow {
    ...
    public /* synthetic */ CommunalInteractor$special$$inlined$map$2(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new CommunalInteractor$isCommunalShowing$lambda$6$$inlined$map$1$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = ((FlowKt__ZipKt$combine$$inlined$unsafeFlow$1) this.$this_unsafeTransform$inlined).collect(new CommunalInteractor$special$$inlined$map$1$2(flowCollector), continuation);
