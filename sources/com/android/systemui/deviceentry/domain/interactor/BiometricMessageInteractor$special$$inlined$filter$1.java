...
public final class BiometricMessageInteractor$special$$inlined$filter$1 implements Flow {
    ...
    public /* synthetic */ BiometricMessageInteractor$special$$inlined$filter$1(SafeFlow safeFlow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new BiometricMessageInteractor$special$$inlined$filter$2$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 2:
                Object collect3 = this.$this_unsafeTransform$inlined.collect(new BiometricMessageInteractor$special$$inlined$filter$3$2(flowCollector), continuation);
                if (collect3 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 3:
                Object collect4 = this.$this_unsafeTransform$inlined.collect(new BiometricMessageInteractor$special$$inlined$filter$4$2(flowCollector), continuation);
                if (collect4 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect5 = this.$this_unsafeTransform$inlined.collect(new BiometricMessageInteractor$special$$inlined$filter$5$2(flowCollector), continuation);
