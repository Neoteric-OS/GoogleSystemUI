...
public final class DeviceEntrySourceInteractor$special$$inlined$map$1 implements Flow {
    ...
    public final class AnonymousClass2 implements FlowCollector {
        ...
        */
        public final java.lang.Object emit(java.lang.Object r5, kotlin.coroutines.Continuation r6) {
            /*
                r4 = this;
                boolean r0 = r6 instanceof com.android.systemui.deviceentry.domain.interactor.DeviceEntrySourceInteractor$special$$inlined$map$1.AnonymousClass2.AnonymousClass1
                if (r0 == 0) goto L13
                r0 = r6
    ...
    public /* synthetic */ DeviceEntrySourceInteractor$special$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((DeviceEntrySourceInteractor$special$$inlined$map$1) this.$this_unsafeTransform$inlined).collect(new AnonymousClass2(flowCollector), continuation);
                if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 1:
                ((ReadonlyStateFlow) this.$this_unsafeTransform$inlined).collect(new DeviceEntrySourceInteractor$special$$inlined$filter$1$2(flowCollector), continuation);
                break;
            case 2:
                Object collect2 = ((SafeFlow) this.$this_unsafeTransform$inlined).collect(new DeviceEntrySourceInteractor$special$$inlined$filter$2$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = ((DeviceEntrySourceInteractor$special$$inlined$map$1) this.$this_unsafeTransform$inlined).collect(new DeviceEntrySourceInteractor$special$$inlined$map$2$2(flowCollector), continuation);
