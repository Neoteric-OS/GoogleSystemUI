...
public final class BiometricMessageInteractor$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ BiometricMessageInteractor$special$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((BiometricMessageInteractor$special$$inlined$filter$1) this.$this_unsafeTransform$inlined).collect(new AnonymousClass2(flowCollector), continuation);
                if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 1:
                Object collect2 = ((BiometricMessageInteractor$special$$inlined$map$3) this.$this_unsafeTransform$inlined).collect(new BiometricMessageInteractor$filterConditionForFaceHelpMessages$lambda$13$$inlined$map$1$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 2:
                Object collect3 = ((BiometricMessageInteractor$special$$inlined$filter$1) this.$this_unsafeTransform$inlined).collect(new BiometricMessageInteractor$special$$inlined$map$2$2(flowCollector), continuation);
                if (collect3 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect4 = ((BiometricMessageInteractor$special$$inlined$filter$1) this.$this_unsafeTransform$inlined).collect(new BiometricMessageInteractor$special$$inlined$map$4$2(flowCollector), continuation);
