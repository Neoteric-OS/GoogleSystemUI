...
public final class DeviceEntryHapticsInteractor$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ DeviceEntryHapticsInteractor$special$$inlined$map$1(Flow flow, DeviceEntryHapticsInteractor deviceEntryHapticsInteractor, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((DeviceEntryHapticsInteractor$special$$inlined$map$2) this.$this_unsafeTransform$inlined).collect(new AnonymousClass2(flowCollector, this.this$0), continuation);
                if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 1:
                Object collect2 = ((SafeFlow) this.$this_unsafeTransform$inlined).collect(new DeviceEntryHapticsInteractor$special$$inlined$filter$2$2(flowCollector, this.this$0), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = ((SafeFlow) this.$this_unsafeTransform$inlined).collect(new DeviceEntryHapticsInteractor$special$$inlined$filter$3$2(flowCollector, this.this$0), continuation);
