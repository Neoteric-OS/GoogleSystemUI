...
public final class DeviceEntryBiometricAuthInteractor$special$$inlined$flatMapLatest$1 extends SuspendLambda implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow deviceEntryBiometricAuthInteractor$special$$inlined$map$1 = ((Boolean) this.L$1).booleanValue() ? new DeviceEntryBiometricAuthInteractor$special$$inlined$map$1(this.$deviceEntryFaceAuthInteractor$inlined.getAuthenticationStatus(), 1) : EmptyFlow.INSTANCE;
            this.label = 1;
            if (FlowKt.emitAll(flowCollector, deviceEntryBiometricAuthInteractor$special$$inlined$map$1, this) == coroutineSingletons) {
