...
public final class DeviceEntryHapticsInteractor$special$$inlined$map$2 implements Flow {
    ...
    public final class AnonymousClass2 implements FlowCollector {
        ...
        */
        public final java.lang.Object emit(java.lang.Object r6, kotlin.coroutines.Continuation r7) {
            /*
                r5 = this;
                boolean r0 = r7 instanceof com.android.systemui.deviceentry.domain.interactor.DeviceEntryHapticsInteractor$special$$inlined$map$2.AnonymousClass2.AnonymousClass1
                if (r0 == 0) goto L13
                r0 = r7
    ...
    public /* synthetic */ DeviceEntryHapticsInteractor$special$$inlined$map$2(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((DeviceEntryHapticsInteractor$special$$inlined$map$1) this.$this_unsafeTransform$inlined).collect(new AnonymousClass2(flowCollector), continuation);
                if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 1:
                ((ReadonlyStateFlow) this.$this_unsafeTransform$inlined).collect(new DeviceEntryHapticsInteractor$special$$inlined$filter$1$2(flowCollector), continuation);
                break;
            case 2:
                Object collect2 = ((ChannelLimitedFlowMerge) this.$this_unsafeTransform$inlined).collect(new DeviceEntryHapticsInteractor$special$$inlined$map$3$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = ((DeviceEntryHapticsInteractor$special$$inlined$map$1) this.$this_unsafeTransform$inlined).collect(new DeviceEntryHapticsInteractor$special$$inlined$map$4$2(flowCollector), continuation);
