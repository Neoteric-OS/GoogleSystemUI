...
public final class DeviceEntryFingerprintAuthInteractor$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ DeviceEntryFingerprintAuthInteractor$special$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new DeviceEntryFingerprintAuthInteractor$special$$inlined$filterIsInstance$1$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 2:
                Object collect3 = this.$this_unsafeTransform$inlined.collect(new DeviceEntryFingerprintAuthInteractor$special$$inlined$filterIsInstance$2$2(flowCollector), continuation);
                if (collect3 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 3:
                Object collect4 = this.$this_unsafeTransform$inlined.collect(new DeviceEntryFingerprintAuthInteractor$special$$inlined$filterIsInstance$3$2(flowCollector), continuation);
                if (collect4 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect5 = this.$this_unsafeTransform$inlined.collect(new DeviceEntryFingerprintAuthInteractor$special$$inlined$filterIsInstance$4$2(flowCollector), continuation);
