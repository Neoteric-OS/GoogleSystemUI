...
public final class DeviceEntryInteractor$special$$inlined$map$3 implements Flow {
    ...
    public /* synthetic */ DeviceEntryInteractor$special$$inlined$map$3(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new DeviceEntryInteractor$canSwipeToEnter$2$invoke$$inlined$map$1$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = this.$this_unsafeTransform$inlined.collect(new DeviceEntryInteractor$special$$inlined$filter$1$2(flowCollector), continuation);
