...
public final class OneHandedModeRepositoryImpl {
    public final CoroutineContext bgCoroutineContext;
    public final CoroutineScope scope;
    public final SecureSettings secureSettings;
    public final Map userMap = new LinkedHashMap();

    public OneHandedModeRepositoryImpl(SecureSettings secureSettings, CoroutineContext coroutineContext, CoroutineScope coroutineScope) {
    ...
    public final Flow isEnabled(final UserHandle userHandle) {
        ...
        if (obj == null) {
            final FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new OneHandedModeRepositoryImpl$isEnabled$1$1(2, null), SettingsProxyExt.observerFlow(this.secureSettings, userHandle.getIdentifier(), "one_handed_mode_enabled"));
            ...
            }), this.bgCoroutineContext), this.scope, SharingStarted.Companion.WhileSubscribed$default(3), Boolean.FALSE);
            map.put(valueOf, obj);
        }
        return (Flow) obj;
    }
