...
final class AccessibilityRepositoryImpl$isEnabled$1 extends SuspendLambda implements Function2 {
    ...
    /* JADX WARN: Type inference failed for: r3v1, types: [android.view.accessibility.AccessibilityManager$AccessibilityStateChangeListener, com.android.systemui.accessibility.data.repository.AccessibilityRepositoryKt$sam$android_view_accessibility_AccessibilityManager_AccessibilityStateChangeListener$0] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final AccessibilityRepositoryImpl$isEnabled$1$listener$1 accessibilityRepositoryImpl$isEnabled$1$listener$1 = new AccessibilityRepositoryImpl$isEnabled$1$listener$1(1, producerScope, ProducerScope.class, "trySend", "trySend-JP2dKIU(Ljava/lang/Object;)Ljava/lang/Object;", 8);
            final ?? r3 = new AccessibilityManager.AccessibilityStateChangeListener() { // from class: com.android.systemui.accessibility.data.repository.AccessibilityRepositoryKt$sam$android_view_accessibility_AccessibilityManager_AccessibilityStateChangeListener$0
                @Override // android.view.accessibility.AccessibilityManager.AccessibilityStateChangeListener
                public final /* synthetic */ void onAccessibilityStateChanged(boolean z) {
                    Function1.this.invoke(Boolean.valueOf(z));
                }
            };
            this.$manager.addAccessibilityStateChangeListener(r3);
            ProducerCoroutine producerCoroutine = (ProducerCoroutine) producerScope;
            producerCoroutine.mo1790trySendJP2dKIU(Boolean.valueOf(this.$manager.isEnabled()));
            ...
            Function0 function0 = new Function0() { // from class: com.android.systemui.accessibility.data.repository.AccessibilityRepositoryImpl$isEnabled$1.1
                ...
                public final Object invoke() {
                    accessibilityManager.removeAccessibilityStateChangeListener(r3);
