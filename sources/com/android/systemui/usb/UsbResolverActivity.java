    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (this.mForwardResolveInfo != null) {
            if (arrayList2.size() > 1) {
                ...
                intent4.setComponent(ComponentName.unflattenFromString(getResources().getString(R.string.config_wearRemoteIntentAction)));
        ...
        super.onCreate(bundle, intent2, getResources().getText(R.string.clearDefaultHintMsg), (Intent[]) null, arrayList, true);
        CheckBox checkBox = (CheckBox) findViewById(R.id.atThumb);
        if (checkBox != null) {
            if (this.mDevice == null) {
                checkBox.setText(com.android.wm.shell.R.string.always_use_accessory);
            } else {
                checkBox.setText(com.android.wm.shell.R.string.always_use_device);
            }
        }
    }
