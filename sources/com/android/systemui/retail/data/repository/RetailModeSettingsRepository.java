...
public final class RetailModeSettingsRepository {
    ...
    public RetailModeSettingsRepository(final GlobalSettings globalSettings, CoroutineDispatcher coroutineDispatcher, CoroutineScope coroutineScope) {
        final FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new RetailModeSettingsRepository$retailMode$2(2, null), FlowConflatedKt.conflatedCallbackFlow(new RetailModeSettingsRepository$retailMode$1(globalSettings, null)));
        this.retailMode = FlowKt.stateIn(FlowKt.flowOn(new Flow() { // from class: com.android.systemui.retail.data.repository.RetailModeSettingsRepository$special$$inlined$map$1
            ...
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object collect = FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1.this.collect(new AnonymousClass2(flowCollector, globalSettings), continuation);
                return collect == CoroutineSingletons.COROUTINE_SUSPENDED ? collect : Unit.INSTANCE;
            }
        }, coroutineDispatcher), coroutineScope, SharingStarted.Companion.Eagerly, Boolean.FALSE);
    }

    public boolean getInRetailMode() {
        return ((Boolean) this.retailMode.getValue()).booleanValue();
    }
}
