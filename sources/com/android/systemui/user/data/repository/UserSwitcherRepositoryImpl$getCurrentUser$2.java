...
final class UserSwitcherRepositoryImpl$getCurrentUser$2 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        UserRecord userRecord = (UserRecord) ((StateFlowImpl) userSwitcherController.getMUserSwitcherInteractor().selectedUserRecord.$$delegate_0).getValue();
        if (userRecord == null) {
            return null;
        }
        return LegacyUserUiHelper.getUserRecordName(userSwitcherController.applicationContext, userRecord, userSwitcherController.getMUserSwitcherInteractor().isGuestUserAutoCreated, userSwitcherController.getMUserSwitcherInteractor().isGuestUserResetting);
    }
}
