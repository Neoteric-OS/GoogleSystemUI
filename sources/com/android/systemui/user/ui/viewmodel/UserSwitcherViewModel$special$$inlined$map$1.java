...
public final class UserSwitcherViewModel$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ UserSwitcherViewModel$special$$inlined$map$1(Flow flow, UserSwitcherViewModel userSwitcherViewModel, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((UserSwitcherInteractor$special$$inlined$map$2) this.$this_unsafeTransform$inlined).collect(new AnonymousClass2(flowCollector, this.this$0), continuation);
                if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 1:
                Object collect2 = ((FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1) this.$this_unsafeTransform$inlined).collect(new UserSwitcherViewModel$special$$inlined$map$2$2(flowCollector, this.this$0), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 2:
                Object collect3 = ((UserSwitcherViewModel$special$$inlined$map$1) this.$this_unsafeTransform$inlined).collect(new UserSwitcherViewModel$special$$inlined$map$3$2(flowCollector, this.this$0), continuation);
                if (collect3 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect4 = this.$this_unsafeTransform$inlined.collect(new UserSwitcherViewModel$special$$inlined$map$4$2(flowCollector, this.this$0), continuation);
