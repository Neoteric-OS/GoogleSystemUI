...
public final class BooleanFlowOperators$not$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ BooleanFlowOperators$not$$inlined$map$1(int i, Object obj) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((Flow) this.$this_unsafeTransform$inlined).collect(new AnonymousClass2(flowCollector), continuation);
            ...
            case 1:
                ...
                Object combineInternal = CombineKt.combineInternal(continuation, new Function0() { // from class: com.android.systemui.util.kotlin.BooleanFlowOperators$all$$inlined$combine$1$2
                ...
                }, new BooleanFlowOperators$all$$inlined$combine$1$3(3, null), flowCollector, flowArr);
                if (combineInternal != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                final Flow[] flowArr2 = (Flow[]) this.$this_unsafeTransform$inlined;
                Object combineInternal2 = CombineKt.combineInternal(continuation, new Function0() { // from class: com.android.systemui.util.kotlin.BooleanFlowOperators$any$$inlined$combine$1$2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                ...
                }, new BooleanFlowOperators$any$$inlined$combine$1$3(3, null), flowCollector, flowArr2);
