...
final class BatteryControllerExtKt$isExtremePowerSaverEnabled$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invoke(Object obj, Object obj2) {
        return ((BatteryControllerExtKt$isExtremePowerSaverEnabled$1) create((ProducerScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r1v1, types: [com.android.systemui.util.kotlin.BatteryControllerExtKt$isExtremePowerSaverEnabled$1$batteryCallback$1, java.lang.Object] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final ?? r1 = new BatteryController.BatteryStateChangeCallback() { // from class: com.android.systemui.util.kotlin.BatteryControllerExtKt$isExtremePowerSaverEnabled$1$batteryCallback$1
            ...
            this.$this_isExtremePowerSaverEnabled.addCallback(r1);
            final BatteryController batteryController = this.$this_isExtremePowerSaverEnabled;
            Function0 function0 = new Function0() { // from class: com.android.systemui.util.kotlin.BatteryControllerExtKt$isExtremePowerSaverEnabled$1.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
