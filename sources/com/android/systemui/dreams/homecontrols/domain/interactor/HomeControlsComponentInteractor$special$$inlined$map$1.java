...
public final class HomeControlsComponentInteractor$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ HomeControlsComponentInteractor$special$$inlined$map$1(ChannelFlowTransformLatest channelFlowTransformLatest, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            default:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new HomeControlsComponentInteractor$monitorUpdatesAndRestart$$inlined$filter$1$2(flowCollector), continuation);
