    ...
    public final Flow autoAddSignal(int i) {
        ...
        final Flow distinctUntilChanged = FlowKt.distinctUntilChanged(new FlowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1(new Flow() { // from class: com.android.systemui.qs.pipeline.domain.autoaddable.A11yShortcutAutoAddable$autoAddSignal$$inlined$map$1
            ...
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                switch (i2) {
                    case 0:
                        Object collect = ((SharedFlow) readonlySharedFlow).collect(new AnonymousClass2(flowCollector, this), continuation);
                        if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                            break;
                        }
                        break;
                    default:
                        Object collect2 = readonlySharedFlow.collect(new A11yShortcutAutoAddable$autoAddSignal$$inlined$map$2$2(flowCollector, this), continuation);
        ...
        final int i3 = 1;
        return FlowKt.flowOn(new Flow() { // from class: com.android.systemui.qs.pipeline.domain.autoaddable.A11yShortcutAutoAddable$autoAddSignal$$inlined$map$1
            ...
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                switch (i3) {
                    case 0:
                        Object collect = ((SharedFlow) distinctUntilChanged).collect(new AnonymousClass2(flowCollector, this), continuation);
                        if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                            break;
                        }
                        break;
                    default:
                        Object collect2 = distinctUntilChanged.collect(new A11yShortcutAutoAddable$autoAddSignal$$inlined$map$2$2(flowCollector, this), continuation);
                        if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                            break;
                        }
                        break;
