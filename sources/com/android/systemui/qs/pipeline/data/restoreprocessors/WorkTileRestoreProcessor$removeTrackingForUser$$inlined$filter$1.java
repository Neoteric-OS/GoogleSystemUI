...
public final class WorkTileRestoreProcessor$removeTrackingForUser$$inlined$filter$1 implements Flow {
    ...
    public WorkTileRestoreProcessor$removeTrackingForUser$$inlined$filter$1(SharedFlowImpl sharedFlowImpl, UserHandle userHandle) {
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        this.$this_unsafeTransform$inlined.collect(new AnonymousClass2(flowCollector, this.$userHandle$inlined), continuation);
