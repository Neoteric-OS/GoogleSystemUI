...
public final class InternetTileUserActionInteractor implements QSTileUserActionInteractor {
    ...
    public InternetTileUserActionInteractor(CoroutineContext coroutineContext, InternetDialogManager internetDialogManager, WifiStateWorker wifiStateWorker, AccessPointController accessPointController, QSTileIntentUserInputHandlerImpl qSTileIntentUserInputHandlerImpl) {
    ...
    public final Object handleInput(QSTileInput qSTileInput, Continuation continuation) {
        ...
        if (qSTileUserAction instanceof QSTileUserAction.Click) {
            ...
            this.wifiStateWorker.setWifiEnabled(!r2.isWifiEnabled());
        } else if (qSTileUserAction instanceof QSTileUserAction.LongClick) {
            QSTileIntentUserInputHandlerImpl.handle$default(this.qsTileIntentUserActionHandler, ((QSTileUserAction.LongClick) qSTileUserAction).expandable, new Intent("android.settings.WIFI_SETTINGS"));
        }
