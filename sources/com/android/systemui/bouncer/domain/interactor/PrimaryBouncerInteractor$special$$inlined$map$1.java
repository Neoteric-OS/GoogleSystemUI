...
public final class PrimaryBouncerInteractor$special$$inlined$map$1 implements Flow {
    ...
    public final class AnonymousClass2 implements FlowCollector {
        ...
        */
        public final java.lang.Object emit(java.lang.Object r6, kotlin.coroutines.Continuation r7) {
            /*
                r5 = this;
                boolean r0 = r7 instanceof com.android.systemui.bouncer.domain.interactor.PrimaryBouncerInteractor$special$$inlined$map$1.AnonymousClass2.AnonymousClass1
                if (r0 == 0) goto L13
                r0 = r7
    ...
    public /* synthetic */ PrimaryBouncerInteractor$special$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((PrimaryBouncerInteractor$special$$inlined$filter$1) this.$this_unsafeTransform$inlined).collect(new AnonymousClass2(flowCollector), continuation);
                if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 1:
                Object collect2 = ((PrimaryBouncerInteractor$special$$inlined$filter$1) this.$this_unsafeTransform$inlined).collect(new PrimaryBouncerInteractor$special$$inlined$map$2$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = ((FlowKt__ZipKt$combine$$inlined$unsafeFlow$1) this.$this_unsafeTransform$inlined).collect(new PrimaryBouncerInteractor$special$$inlined$map$3$2(flowCollector), continuation);
