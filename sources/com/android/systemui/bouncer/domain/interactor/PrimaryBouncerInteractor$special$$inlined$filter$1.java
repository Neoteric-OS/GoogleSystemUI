...
public final class PrimaryBouncerInteractor$special$$inlined$filter$1 implements Flow {
    ...
    public /* synthetic */ PrimaryBouncerInteractor$special$$inlined$filter$1(StateFlow stateFlow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new PrimaryBouncerInteractor$special$$inlined$filter$2$2(flowCollector), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = this.$this_unsafeTransform$inlined.collect(new PrimaryBouncerInteractor$special$$inlined$filter$3$2(flowCollector), continuation);
