...
public final class SideFpsSensorInteractor$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ SideFpsSensorInteractor$special$$inlined$map$1(Flow flow, Object obj, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((FlowKt__ZipKt$combine$$inlined$unsafeFlow$1) this.$this_unsafeTransform$inlined).collect(new AnonymousClass2(flowCollector, (SideFpsSensorInteractor) this.this$0), continuation);
                if (collect != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            case 1:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new SideFpsSensorInteractor$special$$inlined$map$3$2(flowCollector, (SideFpsSensorInteractor) this.this$0), continuation);
                if (collect2 != CoroutineSingletons.COROUTINE_SUSPENDED) {
                    break;
                }
                break;
            default:
                Object collect3 = ((FlowKt__ZipKt$combine$$inlined$unsafeFlow$1) this.$this_unsafeTransform$inlined).collect(new SideFpsSensorInteractor$special$$inlined$map$5$2(flowCollector, (WindowManager) this.this$0), continuation);
