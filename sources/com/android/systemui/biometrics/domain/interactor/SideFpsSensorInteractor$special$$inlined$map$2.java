...
public final class SideFpsSensorInteractor$special$$inlined$map$2 implements Flow {
    ...
    public /* synthetic */ SideFpsSensorInteractor$special$$inlined$map$2(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            default:
                Object collect2 = ((SideFpsSensorInteractor$special$$inlined$map$1) this.$this_unsafeTransform$inlined).collect(new SideFpsSensorInteractor$special$$inlined$map$4$2(flowCollector), continuation);
