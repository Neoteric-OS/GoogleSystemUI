        ...
        if (i == 0) {
            ...
            final ?? r1 = new AuthController.Callback() { // from class: com.android.systemui.biometrics.data.repository.PromptRepositoryImpl$isShowing$1$callback$1
                ...
                public final void onBiometricPromptDismissed() {
                    Object mo1790trySendJP2dKIU = ((ProducerCoroutine) ProducerScope.this)._channel.mo1790trySendJP2dKIU(Boolean.FALSE);
                    if (mo1790trySendJP2dKIU instanceof ChannelResult.Failed) {
                        Log.e("PromptRepositoryImpl", "Failed to send unset isShowing - downstream canceled or failed.", ChannelResult.m1791exceptionOrNullimpl(mo1790trySendJP2dKIU));
                    }
                }

                @Override // com.android.systemui.biometrics.AuthController.Callback
                public final void onBiometricPromptShown() {
                    Object mo1790trySendJP2dKIU = ((ProducerCoroutine) ProducerScope.this)._channel.mo1790trySendJP2dKIU(Boolean.TRUE);
                    if (mo1790trySendJP2dKIU instanceof ChannelResult.Failed) {
                        Log.e("PromptRepositoryImpl", "Failed to send set isShowing - downstream canceled or failed.", ChannelResult.m1791exceptionOrNullimpl(mo1790trySendJP2dKIU));
                    }
                }
            };
            this.this$0.authController.addCallback(r1);
            Object mo1790trySendJP2dKIU = ((ProducerCoroutine) producerScope)._channel.mo1790trySendJP2dKIU(Boolean.valueOf(this.this$0.authController.isShowing()));
            if (mo1790trySendJP2dKIU instanceof ChannelResult.Failed) {
                Log.e("PromptRepositoryImpl", "Failed to send update isShowing - downstream canceled or failed.", ChannelResult.m1791exceptionOrNullimpl(mo1790trySendJP2dKIU));
            }
