...
public final class PowerInteractor$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ PowerInteractor$special$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            default:
                Object collect2 = ((DistinctFlowImpl) this.$this_unsafeTransform$inlined).collect(new PowerInteractor$special$$inlined$map$2$2(flowCollector), continuation);
