...
public class SavedDeviceItemFactory extends DeviceItemFactory {
    ...
    public boolean isFilterMatched(Context context, CachedBluetoothDevice cachedBluetoothDevice, AudioManager audioManager) {
        return (BluetoothUtils.isExclusivelyManagedBluetoothDevice(context, cachedBluetoothDevice.mDevice) || cachedBluetoothDevice.mDevice.getBondState() != 12 || cachedBluetoothDevice.isConnected()) ? false : true;
    }
}
