...
public final class AvailableAudioSharingMediaDeviceItemFactory extends AvailableMediaDeviceItemFactory {
    ...
    public final DeviceItem create(Context context, CachedBluetoothDevice cachedBluetoothDevice) {
        DeviceItemType deviceItemType = DeviceItemType.AVAILABLE_AUDIO_SHARING_MEDIA_BLUETOOTH_DEVICE;
        String string = context.getString(R.string.quick_settings_bluetooth_device_audio_sharing_or_switch_active);
        ...
        return new DeviceItem(deviceItemType, cachedBluetoothDevice, name, string, new kotlin.Pair(btClassDrawableWithDescription.first, btClassDrawableWithDescription.second), Integer.valueOf(i), !cachedBluetoothDevice.isBusy(), "", false);
    }
