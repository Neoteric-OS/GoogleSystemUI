...
public final class PrivacyChipInteractor {
    ...
    public final PrivacyChipRepositoryImpl repository;

    public PrivacyChipInteractor(CoroutineScope coroutineScope, PrivacyChipRepositoryImpl privacyChipRepositoryImpl, PrivacyDialogController privacyDialogController, PrivacyDialogControllerV2 privacyDialogControllerV2, DeviceProvisionedController deviceProvisionedController) {
        ...
        FlowKt.stateIn(flow, coroutineScope, WhileSubscribed$default, bool);
        FlowKt.stateIn(new FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(readonlyStateFlow2, readonlyStateFlow3, new PrivacyChipInteractor$isChipEnabled$1(3, null)), coroutineScope, SharingStarted.Companion.WhileSubscribed$default(3), bool);
    }
}
