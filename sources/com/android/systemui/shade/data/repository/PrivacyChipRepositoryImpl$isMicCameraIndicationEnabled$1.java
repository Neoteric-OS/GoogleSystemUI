...
final class PrivacyChipRepositoryImpl$isMicCameraIndicationEnabled$1 extends SuspendLambda implements Function2 {
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [com.android.systemui.privacy.PrivacyConfig$Callback, com.android.systemui.shade.data.repository.PrivacyChipRepositoryImpl$isMicCameraIndicationEnabled$1$callback$1] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final ?? r1 = new PrivacyConfig.Callback() { // from class: com.android.systemui.shade.data.repository.PrivacyChipRepositoryImpl$isMicCameraIndicationEnabled$1$callback$1
            ...
            Function0 function0 = new Function0() { // from class: com.android.systemui.shade.data.repository.PrivacyChipRepositoryImpl$isMicCameraIndicationEnabled$1.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
                ...
                public final Object invoke() {
                    ...
                    PrivacyChipRepositoryImpl$isMicCameraIndicationEnabled$1$callback$1 privacyChipRepositoryImpl$isMicCameraIndicationEnabled$1$callback$1 = r1;
                    privacyConfig.getClass();
                    ((ExecutorImpl) privacyConfig.uiExecutor).execute(new PrivacyConfig$addCallback$1(privacyConfig, new WeakReference(privacyChipRepositoryImpl$isMicCameraIndicationEnabled$1$callback$1), 1));
