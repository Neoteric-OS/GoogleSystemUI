...
import com.android.systemui.unfold.UnfoldTraceLogger$start$1;
...
final class UnfoldTraceLogger$start$3 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            TraceStateLogger traceStateLogger = new TraceStateLogger("FoldedState", 14);
            Flow isFolded = this.this$0.deviceStateRepository.isFolded();
            UnfoldTraceLogger$start$1.AnonymousClass1 anonymousClass1 = new UnfoldTraceLogger$start$1.AnonymousClass1(traceStateLogger, 1);
            this.label = 1;
            if (isFolded.collect(anonymousClass1, this) == coroutineSingletons) {
