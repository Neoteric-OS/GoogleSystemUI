...
public final class DisplaySwitchLatencyTracker$start$1$invokeSuspend$$inlined$filter$1 implements Flow {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ CancellableFlow $this_unsafeTransform$inlined;
        ...
        */
        public final java.lang.Object emit(java.lang.Object r6, kotlin.coroutines.Continuation r7) {
            ...
            L2f:
                ...
                java.lang.Object r2 = r7.previousValue
    ...
    public /* synthetic */ DisplaySwitchLatencyTracker$start$1$invokeSuspend$$inlined$filter$1(CancellableFlow cancellableFlow, int i) {
        this.$r8$classId = i;
        this.$this_unsafeTransform$inlined = cancellableFlow;
    }
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((SafeFlow) this.$this_unsafeTransform$inlined).collect(new AnonymousClass2(flowCollector), continuation);
                return collect == CoroutineSingletons.COROUTINE_SUSPENDED ? collect : Unit.INSTANCE;
            default:
                ((ReadonlyStateFlow) this.$this_unsafeTransform$inlined).collect(new DisplaySwitchLatencyTracker$waitForScreenTurnedOn$lambda$2$$inlined$filter$1$2(flowCollector), continuation);
