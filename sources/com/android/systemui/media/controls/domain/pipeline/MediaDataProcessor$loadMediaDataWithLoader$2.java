...
final class MediaDataProcessor$loadMediaDataWithLoader$2 extends SuspendLambda implements Function2 {
    ...
    final class AnonymousClass1 extends SuspendLambda implements Function2 {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                Assert.isMainThread();
                if (((Map) ((StateFlowImpl) mediaDataRepository.mediaEntries.$$delegate_0).getValue()).containsKey(str)) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MediaDataProcessor$loadMediaDataWithLoader$2(StatusBarNotification statusBarNotification, MediaDataProcessor mediaDataProcessor, String str, String str2, Continuation continuation, boolean z) {
        super(2, continuation);
        this.this$0 = mediaDataProcessor;
        this.$key = str;
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        MediaDataProcessor mediaDataProcessor = this.this$0;
        String str = this.$key;
        return new MediaDataProcessor$loadMediaDataWithLoader$2(this.$sbn, mediaDataProcessor, str, this.$oldKey, continuation, this.$isNewlyActiveEntry);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            loadMediaData = mediaDataLoader.loadMediaData(str, statusBarNotification, false, this);
        ...
        if (z) {
            ...
            MediaDataRepository mediaDataRepository = mediaDataProcessor.mediaDataRepository;
            int size = ((Map) ((StateFlowImpl) mediaDataRepository.mediaEntries.$$delegate_0).getValue()).size();
            ...
            if (size == 1) {
                ...
                instanceId = instanceId2;
                if (((Map) ((StateFlowImpl) mediaDataRepository.mediaEntries.$$delegate_0).getValue()).size() == 2) {
