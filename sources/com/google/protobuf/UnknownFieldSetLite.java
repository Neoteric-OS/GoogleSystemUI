...
public final class UnknownFieldSetLite {
        ...
        for (int i3 = 0; i3 < this.count; i3++) {
            ...
            if (i6 != 0) {
                if (i6 == 1) {
                    ...
                    computeFixed64Size = CodedOutputStream.computeFixed64Size(i5);
                } else if (i6 == 2) {
                    computeFixed64Size = CodedOutputStream.computeBytesSize(i5, (ByteString) this.objects[i3]);
                } else if (i6 == 3) {
                    ...
                    computeFixed64Size = CodedOutputStream.computeFixed32Size(i5);
                }
    ...
    public final void writeTo(CodedOutputStreamWriter codedOutputStreamWriter) {
        ...
        for (int i = 0; i < this.count; i++) {
            ...
            if (i4 == 0) {
                codedOutputStream.writeUInt64(((Long) obj).longValue(), i3);
            } else if (i4 == 1) {
                codedOutputStream.writeFixed64(((Long) obj).longValue(), i3);
            } else if (i4 == 2) {
                ...
                codedOutputStream.writeFixed32(i3, ((Integer) obj).intValue());
            }
        }
    }
}
