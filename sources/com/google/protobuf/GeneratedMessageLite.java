...
public abstract class GeneratedMessageLite extends AbstractMessageLite {
    ...
    public static GeneratedMessageLite parseFrom(GeneratedMessageLite generatedMessageLite, InputStream inputStream) {
        CodedInputStream$StreamDecoder codedInputStream$StreamDecoder = new CodedInputStream$StreamDecoder(inputStream);
        ...
        try {
            ...
            CodedInputStreamReader codedInputStreamReader = codedInputStream$StreamDecoder.wrapper;
            if (codedInputStreamReader == null) {
                codedInputStreamReader = new CodedInputStreamReader(codedInputStream$StreamDecoder);
            }
            ...
            if (isInitialized(newMutableInstance$1, true)) {
