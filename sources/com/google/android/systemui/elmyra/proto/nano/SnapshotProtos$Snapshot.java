...
public final class SnapshotProtos$Snapshot extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        int i = 0;
        int computeMessageSize = snapshotProtos$SnapshotHeader != null ? CodedOutputByteBufferNano.computeMessageSize(1, snapshotProtos$SnapshotHeader) : 0;
        ...
        if (snapshotProtos$EventArr != null && snapshotProtos$EventArr.length > 0) {
            while (true) {
                ...
                if (snapshotProtos$Event != null) {
                    computeMessageSize = CodedOutputByteBufferNano.computeMessageSize(2, snapshotProtos$Event) + computeMessageSize;
                }
                i++;
            }
        }
        return Float.floatToIntBits(this.sensitivitySetting) != Float.floatToIntBits(0.0f) ? computeMessageSize + CodedOutputByteBufferNano.computeFloatSize(3) : computeMessageSize;
    }
        ...
        while (true) {
            ...
            if (readTag == 10) {
                ...
                while (length < i - 1) {
                    ...
                    snapshotProtos$EventArr2[length] = snapshotProtos$Event;
                ...
                snapshotProtos$EventArr2[length] = snapshotProtos$Event2;
