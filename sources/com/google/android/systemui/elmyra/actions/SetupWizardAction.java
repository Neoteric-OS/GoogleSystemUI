...
import com.google.android.systemui.dagger.DaggerSysUIGoogleGlobalRootComponent$SysUIGoogleSysUIComponentImpl$SwitchingProvider$75;
...
public final class SetupWizardAction extends Action {
    ...
    public SetupWizardAction(Context context, Executor executor, SettingsAction settingsAction, LaunchOpa launchOpa, DaggerSysUIGoogleGlobalRootComponent$SysUIGoogleSysUIComponentImpl$SwitchingProvider$75 daggerSysUIGoogleGlobalRootComponent$SysUIGoogleSysUIComponentImpl$SwitchingProvider$75, KeyguardUpdateMonitor keyguardUpdateMonitor, ShadeController shadeController) {
        super(executor, null);
        KeyguardUpdateMonitorCallback keyguardUpdateMonitorCallback = new KeyguardUpdateMonitorCallback() { // from class: com.google.android.systemui.elmyra.actions.SetupWizardAction.1
        ...
        this.mUserSwitchCallback = keyguardUpdateMonitorCallback;
        Gate.Listener listener = new Gate.Listener() { // from class: com.google.android.systemui.elmyra.actions.SetupWizardAction.2
        ...
        KeyguardDeferredSetup create = daggerSysUIGoogleGlobalRootComponent$SysUIGoogleSysUIComponentImpl$SwitchingProvider$75.create(Collections.emptySet());
        create.activate();
        create.mListener = listener;
