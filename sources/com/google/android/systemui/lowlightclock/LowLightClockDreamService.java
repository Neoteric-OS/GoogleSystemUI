...
import com.google.android.systemui.lowlightclock.ChargingStatusProvider.ChargingStatusCallback;
...
public class LowLightClockDreamService extends DreamService {
    ...
    public final void onAttachedToWindow() {
        ...
        Preconditions.checkState(chargingStatusProvider.mCallback == null, "ChargingStatusProvider already started!");
        chargingStatusProvider.mCallback = lowLightClockDreamService$$ExternalSyntheticLambda0;
        ChargingStatusProvider.ChargingStatusCallback chargingStatusCallback = chargingStatusProvider.new ChargingStatusCallback();
    ...
    public final void onWakeUp() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            ofFloat.setInterpolator(Interpolators.LINEAR);
            ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(view, (Property<View, Float>) View.TRANSLATION_Y, lowLightClockAnimationProvider.mYTranslationAnimationInStartOffset);
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.systemui.lowlightclock.LowLightClockDreamService.1
