...
final class Gate$setBlocking$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invoke(Object obj, Object obj2) {
        Gate$setBlocking$1 gate$setBlocking$1 = (Gate$setBlocking$1) create((CoroutineScope) obj, (Continuation) obj2);
        Unit unit = Unit.INSTANCE;
        gate$setBlocking$1.invokeSuspend(unit);
        return unit;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (z != z2) {
            gate.isBlocked = z2;
            if (gate.active) {
                Iterator it = gate.listeners.iterator();
                while (it.hasNext()) {
                    BuildersKt.launch$default(coroutineScope, gate.mainPostDispatcher, null, new Gate$setBlocking$1$1$1((Gate.Listener) it.next(), gate, null), 2);
                }
            }
        }
