...
final class SetupWizard$updateBlocking$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invoke(Object obj, Object obj2) {
        SetupWizard$updateBlocking$1 setupWizard$updateBlocking$1 = (SetupWizard$updateBlocking$1) create((CoroutineScope) obj, (Continuation) obj2);
        Unit unit = Unit.INSTANCE;
        setupWizard$updateBlocking$1.invokeSuspend(unit);
        return unit;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        setupWizard.setBlocking((setupWizard.exceptionActive || setupWizard.setupComplete) ? false : true);
