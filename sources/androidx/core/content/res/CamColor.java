...
public final class CamColor {
    ...
    public static CamColor fromColor(int i) {
        ...
        float pow4 = ((float) Math.pow(f18 / f19, viewingConditions.mZ * f20)) * 100.0f;
        Math.sqrt(pow4 / 100.0f);
        float f21 = f19 + 4.0f;
        float pow5 = ((float) Math.pow(1.64d - Math.pow(0.29d, viewingConditions.mN), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos((((((double) f16) < 20.14d ? 360.0f + f16 : f16) * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * viewingConditions.mNc) * viewingConditions.mNcb) * ((float) Math.sqrt((f12 * f12) + (f11 * f11)))) / (f14 + 0.305f), 0.9d)) * ((float) Math.sqrt(pow4 / 100.0d));
        float f22 = viewingConditions.mFlRoot * pow5;
        Math.sqrt((r3 * f20) / f21);
        float f23 = (1.7f * pow4) / ((0.007f * pow4) + 1.0f);
        float log = ((float) Math.log((f22 * 0.0228f) + 1.0f)) * 43.85965f;
        double d2 = f17;
        return new CamColor(f16, pow5, pow4, f23, log * ((float) Math.cos(d2)), log * ((float) Math.sin(d2)));
    }
