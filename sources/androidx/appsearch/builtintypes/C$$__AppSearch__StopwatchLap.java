...
public final class C$$__AppSearch__StopwatchLap implements DocumentClassFactory {
    ...
    public AppSearchSchema getSchema() throws AppSearchException {
        ...
        PropertyConfigParcel propertyConfigParcel2 = new PropertyConfigParcel("lapNumber", 2, 2, null, null, null, new PropertyConfigParcel.IntegerIndexingConfigParcel(), null);
        if (builder.mBuilt) {
            builder.mPropertyConfigParcels = new ArrayList(builder.mPropertyConfigParcels);
            builder.mParentTypes = new LinkedHashSet(builder.mParentTypes);
            builder.mBuilt = false;
        ...
        Preconditions.checkArgumentInRange("cardinality", 2, 1, 3);
        Preconditions.checkArgumentInRange("indexingType", 0, 0, 1);
        PropertyConfigParcel propertyConfigParcel3 = new PropertyConfigParcel("lapDurationMillis", 2, 2, null, null, null, new PropertyConfigParcel.IntegerIndexingConfigParcel(), null);
        if (builder.mBuilt) {
            builder.mPropertyConfigParcels = new ArrayList(builder.mPropertyConfigParcels);
            builder.mParentTypes = new LinkedHashSet(builder.mParentTypes);
            builder.mBuilt = false;
        ...
        Preconditions.checkArgumentInRange("cardinality", 2, 1, 3);
        Preconditions.checkArgumentInRange("indexingType", 0, 0, 1);
        PropertyConfigParcel propertyConfigParcel4 = new PropertyConfigParcel("accumulatedLapDurationMillis", 2, 2, null, null, null, new PropertyConfigParcel.IntegerIndexingConfigParcel(), null);
        if (builder.mBuilt) {
            builder.mPropertyConfigParcels = new ArrayList(builder.mPropertyConfigParcels);
            builder.mParentTypes = new LinkedHashSet(builder.mParentTypes);
            builder.mBuilt = false;
    ...
    @Override // androidx.appsearch.app.DocumentClassFactory
    public StopwatchLap fromGenericDocument(GenericDocument genericDocument, Map map) throws AppSearchException {
        String str;
        String str2;
        ...
        StopwatchLap.Builder builder = new StopwatchLap.Builder(str3, str4);
        ...
        Preconditions.checkArgument("Lap number must start at 1", propertyLong >= 1);
        return new StopwatchLap(builder.mNamespace, builder.mId, builder.mDocumentScore, builder.mCreationTimestampMillis, builder.mDocumentTtlMillis, builder.mName, builder.mAlternateNames, builder.mDescription, builder.mImage, builder.mUrl, builder.mPotentialActions, propertyLong, propertyLong2, propertyLong3);
    }

    @Override // androidx.appsearch.app.DocumentClassFactory
    public GenericDocument toGenericDocument(StopwatchLap stopwatchLap) throws AppSearchException {
        GenericDocument.Builder builder = new GenericDocument.Builder(stopwatchLap.mNamespace, stopwatchLap.mId, SCHEMA_NAME);
        builder.setScore(stopwatchLap.mDocumentScore);
        builder.mDocumentParcelBuilder.mCreationTimestampMillis = stopwatchLap.mCreationTimestampMillis;
        builder.setTtlMillis(stopwatchLap.mDocumentTtlMillis);
        String str = stopwatchLap.mName;
        if (str != null) {
            builder.setPropertyString("name", str);
        }
        List list = stopwatchLap.mAlternateNames;
        if (list != null) {
            builder.setPropertyString("alternateNames", (String[]) list.toArray(new String[0]));
        }
        String str2 = stopwatchLap.mDescription;
        if (str2 != null) {
            builder.setPropertyString(WeatherData.DESCRIPTION_KEY, str2);
        }
        String str3 = stopwatchLap.mImage;
        if (str3 != null) {
            builder.setPropertyString("image", str3);
        }
        String str4 = stopwatchLap.mUrl;
        if (str4 != null) {
            builder.setPropertyString("url", str4);
        }
        List list2 = stopwatchLap.mPotentialActions;
        if (list2 != null) {
        ...
        builder.setPropertyLong("lapNumber", stopwatchLap.mLapNumber);
        builder.setPropertyLong("lapDurationMillis", stopwatchLap.mLapDurationMillis);
        builder.setPropertyLong("accumulatedLapDurationMillis", stopwatchLap.mAccumulatedLapDurationMillis);
        return builder.build();
    }
}
