...
public abstract class OrderedScatterSet {
    ...
    */
    ...
    public final boolean equals(Object obj) {
        ...
        if (orderedScatterSet._size != this._size) {
            return false;
        }
    ...
    public final String toString() {
        Function1 function1 = new Function1() { // from class: androidx.collection.OrderedScatterSet$toString$1
            {
                super(1);
            }
