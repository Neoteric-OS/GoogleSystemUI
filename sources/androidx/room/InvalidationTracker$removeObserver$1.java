...
final class InvalidationTracker$removeObserver$1 extends SuspendLambda implements Function2 {
    final /* synthetic */ InvalidationTracker.Observer $observer;
    int label;
    final /* synthetic */ InvalidationTracker this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InvalidationTracker$removeObserver$1(InvalidationTracker invalidationTracker, InvalidationTracker.Observer observer, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new InvalidationTracker$removeObserver$1(this.this$0, this.$observer, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (triggerBasedInvalidationTracker.removeObserver$room_runtime_release(observer, this) == coroutineSingletons) {
