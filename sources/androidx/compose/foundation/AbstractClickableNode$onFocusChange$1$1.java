...
final class AbstractClickableNode$onFocusChange$1$1 extends SuspendLambda implements Function2 {
    ...
    public AbstractClickableNode$onFocusChange$1$1(AbstractClickableNode abstractClickableNode, PressInteraction$Press pressInteraction$Press, Continuation continuation) {
    ...
    public final Object invoke(Object obj, Object obj2) {
        return ((AbstractClickableNode$onFocusChange$1$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (mutableInteractionSource != null) {
                ...
                this.label = 1;
                if (mutableInteractionSource.emit(pressInteraction$Cancel, this) == coroutineSingletons) {
