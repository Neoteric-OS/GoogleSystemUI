...
final class BoxKt$EmptyBoxMeasurePolicy$1 implements MeasurePolicy {
    ...
    public final MeasureResult mo2measure3p2s80s(MeasureScope measureScope, List list, long j) {
        ...
        layout$1 = measureScope.layout$1(Constraints.m657getMinWidthimpl(j), Constraints.m656getMinHeightimpl(j), MapsKt.emptyMap(), new Function1() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1.1
