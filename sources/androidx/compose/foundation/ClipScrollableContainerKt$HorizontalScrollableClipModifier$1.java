...
public final class ClipScrollableContainerKt$HorizontalScrollableClipModifier$1 implements Shape {
    ...
    public final Outline mo37createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        return new Outline.Rectangle(new Rect(0.0f, -mo45roundToPx0680j_4, Float.intBitsToFloat((int) (j >> 32)), Float.intBitsToFloat((int) (j & 4294967295L)) + mo45roundToPx0680j_4));
    }
}
