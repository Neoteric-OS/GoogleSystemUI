...
final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public final MeasureResult mo3measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable mo479measureBRTryo0 = measurable.mo479measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m654getMaxHeightimpl(j)) < Constraints.m655getMaxWidthimpl(j) ? j : Constraints.m648copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13));
        final int min = Math.min(mo479measureBRTryo0.width, Constraints.m655getMaxWidthimpl(j));
        layout$1 = measureScope.layout$1(min, mo479measureBRTryo0.height, MapsKt.emptyMap(), new Function1() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
