...
public final class LazyStringArrayList extends AbstractProtobufList implements LazyStringList, RandomAccess {
    ...
    public final Object get(int i) {
        ...
        if (obj instanceof ByteString) {
            ...
            if (Utf8.processor.partialIsValidUtf8(literalByteString2.bytes, offsetIntoBytes, literalByteString2.size() + offsetIntoBytes) == 0) {
                this.list.set(i, str);
            }
        } else {
            byte[] bArr = (byte[]) obj;
            str = new String(bArr, Internal.UTF_8);
            Utf8.SafeProcessor safeProcessor = Utf8.processor;
