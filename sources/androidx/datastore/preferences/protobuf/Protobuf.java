...
public final class Protobuf {
    ...
    /* JADX WARN: Type inference failed for: r3v6, types: [androidx.datastore.preferences.protobuf.MessageSetSchema] */
    /* JADX WARN: Type inference failed for: r3v8, types: [androidx.datastore.preferences.protobuf.MessageSetSchema] */
    public final Schema schemaFor(Class cls) {
        ...
        if ((messageInfoFor.flags & 2) == 2) {
            ...
            if (isAssignableFrom) {
                ...
                messageSchema = new MessageSetSchema(unknownFieldSetLiteSchema, extensionSchemaLite, generatedMessageLite);
            }
