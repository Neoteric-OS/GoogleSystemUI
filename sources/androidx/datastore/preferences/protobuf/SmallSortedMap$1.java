...
public final class SmallSortedMap$1 extends AbstractMap {
    ...
    /* JADX WARN: Type inference failed for: r0v1, types: [androidx.datastore.preferences.protobuf.SmallSortedMap$EntrySet] */
    @Override // java.util.AbstractMap, java.util.Map
    public final Set entrySet() {
        if (this.lazyEntrySet == null) {
            this.lazyEntrySet = new AbstractSet() { // from class: androidx.datastore.preferences.protobuf.SmallSortedMap$EntrySet
