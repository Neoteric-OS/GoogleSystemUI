...
public final class ArrayLinkedVariables {
    ...
    public final String toString() {
        ...
        String str = "";
        for (int i2 = 0; i != -1 && i2 < this.mCurrentSize; i2++) {
            StringBuilder m = EditProcessor$generateBatchErrorMessage$1$1$$ExternalSyntheticOutline0.m(DpCornerSize$$ExternalSyntheticOutline0.m(EditProcessor$generateBatchErrorMessage$1$1$$ExternalSyntheticOutline0.m(DocumentClassFactoryRegistry$$ExternalSyntheticOutline0.m(str, " -> ")), this.mArrayValues[i], " : "));
